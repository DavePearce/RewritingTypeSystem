...
public class TestSuite_3_1 extends AbstractTestSuite {
	public static class Part_0 {
		...
		@Test public void test_66() { testValid(test_66_sup,test_66_sub); }
		...
		@Test public void test_80() { testValid(test_80_sup,test_80_sub); }

		private static final SyntacticType test_81_sup = parse("{any}");
		private static final SyntacticType test_81_sub = parse("{!!int}");
		@Test public void test_81() { testValid(test_81_sup,test_81_sub); }
		...
		@Test public void test_87() { testValid(test_87_sup,test_87_sub); }
		...
		@Test public void test_128() { testValid(test_128_sup,test_128_sub); }
		...
		private static final SyntacticType test_182_sup = parse("{{any}}");
		private static final SyntacticType test_182_sub = parse("{any}");
		@Test public void test_182() { testInvalid(test_182_sup,test_182_sub); }

		private static final SyntacticType test_183_sup = parse("{{any}}");
		private static final SyntacticType test_183_sub = parse("{int}");
		@Test public void test_183() { testInvalid(test_183_sup,test_183_sub); }

		private static final SyntacticType test_184_sup = parse("{{any}}");
		private static final SyntacticType test_184_sub = parse("!any");
		@Test public void test_184() { testValid(test_184_sup,test_184_sub); }

		private static final SyntacticType test_185_sup = parse("{{any}}");
		private static final SyntacticType test_185_sub = parse("!int");
		@Test public void test_185() { testInvalid(test_185_sup,test_185_sub); }

		private static final SyntacticType test_186_sup = parse("{{any}}");
		private static final SyntacticType test_186_sub = parse("{{any}}");
		@Test public void test_186() { testValid(test_186_sup,test_186_sub); }

		private static final SyntacticType test_187_sup = parse("{{any}}");
		private static final SyntacticType test_187_sub = parse("{{int}}");
		@Test public void test_187() { testValid(test_187_sup,test_187_sub); }

		private static final SyntacticType test_188_sup = parse("{{any}}");
		private static final SyntacticType test_188_sub = parse("{!any}");
		@Test public void test_188() { testValid(test_188_sup,test_188_sub); }

		private static final SyntacticType test_189_sup = parse("{{any}}");
		private static final SyntacticType test_189_sub = parse("{!int}");
		@Test public void test_189() { testInvalid(test_189_sup,test_189_sub); }

		private static final SyntacticType test_190_sup = parse("{{any}}");
		private static final SyntacticType test_190_sub = parse("!{any}");
		@Test public void test_190() { testInvalid(test_190_sup,test_190_sub); }

		private static final SyntacticType test_191_sup = parse("{{any}}");
		private static final SyntacticType test_191_sub = parse("!{int}");
		@Test public void test_191() { testInvalid(test_191_sup,test_191_sub); }

		private static final SyntacticType test_192_sup = parse("{{any}}");
		private static final SyntacticType test_192_sub = parse("!!any");
		@Test public void test_192() { testInvalid(test_192_sup,test_192_sub); }

		private static final SyntacticType test_193_sup = parse("{{any}}");
		private static final SyntacticType test_193_sub = parse("!!int");
		@Test public void test_193() { testInvalid(test_193_sup,test_193_sub); }

		private static final SyntacticType test_194_sup = parse("{{any}}");
		private static final SyntacticType test_194_sub = parse("{{{any}}}");
		@Test public void test_194() { testValid(test_194_sup,test_194_sub); }

		private static final SyntacticType test_195_sup = parse("{{any}}");
		private static final SyntacticType test_195_sub = parse("{{{int}}}");
		@Test public void test_195() { testValid(test_195_sup,test_195_sub); }

		private static final SyntacticType test_196_sup = parse("{{any}}");
		private static final SyntacticType test_196_sub = parse("{{!any}}");
		@Test public void test_196() { testValid(test_196_sup,test_196_sub); }

		private static final SyntacticType test_197_sup = parse("{{any}}");
		private static final SyntacticType test_197_sub = parse("{{!int}}");
		@Test public void test_197() { testValid(test_197_sup,test_197_sub); }

		private static final SyntacticType test_198_sup = parse("{{any}}");
		private static final SyntacticType test_198_sub = parse("{!{any}}");
		@Test public void test_198() { testInvalid(test_198_sup,test_198_sub); }

		private static final SyntacticType test_199_sup = parse("{{any}}");
		private static final SyntacticType test_199_sub = parse("{!{int}}");
		@Test public void test_199() { testInvalid(test_199_sup,test_199_sub); }

		private static final SyntacticType test_200_sup = parse("{{any}}");
		private static final SyntacticType test_200_sub = parse("{!!any}");
		@Test public void test_200() { testInvalid(test_200_sup,test_200_sub); }

		private static final SyntacticType test_201_sup = parse("{{any}}");
		private static final SyntacticType test_201_sub = parse("{!!int}");
		@Test public void test_201() { testInvalid(test_201_sup,test_201_sub); }

		private static final SyntacticType test_202_sup = parse("{{any}}");
		private static final SyntacticType test_202_sub = parse("!{{any}}");
		@Test public void test_202() { testInvalid(test_202_sup,test_202_sub); }

		private static final SyntacticType test_203_sup = parse("{{any}}");
		private static final SyntacticType test_203_sub = parse("!{{int}}");
		@Test public void test_203() { testInvalid(test_203_sup,test_203_sub); }

		private static final SyntacticType test_204_sup = parse("{{any}}");
		private static final SyntacticType test_204_sub = parse("!{!any}");
		@Test public void test_204() { testInvalid(test_204_sup,test_204_sub); }

		private static final SyntacticType test_205_sup = parse("{{any}}");
		private static final SyntacticType test_205_sub = parse("!{!int}");
		@Test public void test_205() { testInvalid(test_205_sup,test_205_sub); }

		private static final SyntacticType test_206_sup = parse("{{any}}");
		private static final SyntacticType test_206_sub = parse("!!{any}");
		@Test public void test_206() { testInvalid(test_206_sup,test_206_sub); }

		private static final SyntacticType test_207_sup = parse("{{any}}");
		private static final SyntacticType test_207_sub = parse("!!{int}");
		@Test public void test_207() { testInvalid(test_207_sup,test_207_sub); }

		private static final SyntacticType test_208_sup = parse("{{any}}");
		private static final SyntacticType test_208_sub = parse("!!!any");
		@Test public void test_208() { testValid(test_208_sup,test_208_sub); }

		private static final SyntacticType test_209_sup = parse("{{any}}");
		private static final SyntacticType test_209_sub = parse("!!!int");
		@Test public void test_209() { testInvalid(test_209_sup,test_209_sub); }

		private static final SyntacticType test_210_sup = parse("{{int}}");
		private static final SyntacticType test_210_sub = parse("any");
		@Test public void test_210() { testInvalid(test_210_sup,test_210_sub); }

		private static final SyntacticType test_211_sup = parse("{{int}}");
		private static final SyntacticType test_211_sub = parse("int");
		@Test public void test_211() { testInvalid(test_211_sup,test_211_sub); }

		private static final SyntacticType test_212_sup = parse("{{int}}");
		private static final SyntacticType test_212_sub = parse("{any}");
		@Test public void test_212() { testInvalid(test_212_sup,test_212_sub); }

		private static final SyntacticType test_213_sup = parse("{{int}}");
		private static final SyntacticType test_213_sub = parse("{int}");
		@Test public void test_213() { testInvalid(test_213_sup,test_213_sub); }

		private static final SyntacticType test_214_sup = parse("{{int}}");
		private static final SyntacticType test_214_sub = parse("!any");
		@Test public void test_214() { testValid(test_214_sup,test_214_sub); }

		private static final SyntacticType test_215_sup = parse("{{int}}");
		private static final SyntacticType test_215_sub = parse("!int");
		@Test public void test_215() { testInvalid(test_215_sup,test_215_sub); }

		private static final SyntacticType test_216_sup = parse("{{int}}");
		private static final SyntacticType test_216_sub = parse("{{any}}");
		@Test public void test_216() { testInvalid(test_216_sup,test_216_sub); }

		private static final SyntacticType test_217_sup = parse("{{int}}");
		private static final SyntacticType test_217_sub = parse("{{int}}");
		@Test public void test_217() { testValid(test_217_sup,test_217_sub); }

		private static final SyntacticType test_218_sup = parse("{{int}}");
		private static final SyntacticType test_218_sub = parse("{!any}");
		@Test public void test_218() { testValid(test_218_sup,test_218_sub); }

		private static final SyntacticType test_219_sup = parse("{{int}}");
		private static final SyntacticType test_219_sub = parse("{!int}");
		@Test public void test_219() { testInvalid(test_219_sup,test_219_sub); }

		private static final SyntacticType test_220_sup = parse("{{int}}");
		private static final SyntacticType test_220_sub = parse("!{any}");
		@Test public void test_220() { testInvalid(test_220_sup,test_220_sub); }

		private static final SyntacticType test_221_sup = parse("{{int}}");
		private static final SyntacticType test_221_sub = parse("!{int}");
		@Test public void test_221() { testInvalid(test_221_sup,test_221_sub); }

		private static final SyntacticType test_222_sup = parse("{{int}}");
		private static final SyntacticType test_222_sub = parse("!!any");
		@Test public void test_222() { testInvalid(test_222_sup,test_222_sub); }

		private static final SyntacticType test_223_sup = parse("{{int}}");
		private static final SyntacticType test_223_sub = parse("!!int");
		@Test public void test_223() { testInvalid(test_223_sup,test_223_sub); }

		private static final SyntacticType test_224_sup = parse("{{int}}");
		private static final SyntacticType test_224_sub = parse("{{{any}}}");
		@Test public void test_224() { testInvalid(test_224_sup,test_224_sub); }

		private static final SyntacticType test_225_sup = parse("{{int}}");
		private static final SyntacticType test_225_sub = parse("{{{int}}}");
		@Test public void test_225() { testInvalid(test_225_sup,test_225_sub); }

		private static final SyntacticType test_226_sup = parse("{{int}}");
		private static final SyntacticType test_226_sub = parse("{{!any}}");
		@Test public void test_226() { testValid(test_226_sup,test_226_sub); }

		private static final SyntacticType test_227_sup = parse("{{int}}");
		private static final SyntacticType test_227_sub = parse("{{!int}}");
		@Test public void test_227() { testInvalid(test_227_sup,test_227_sub); }

		private static final SyntacticType test_228_sup = parse("{{int}}");
		private static final SyntacticType test_228_sub = parse("{!{any}}");
		@Test public void test_228() { testInvalid(test_228_sup,test_228_sub); }

		private static final SyntacticType test_229_sup = parse("{{int}}");
		private static final SyntacticType test_229_sub = parse("{!{int}}");
		@Test public void test_229() { testInvalid(test_229_sup,test_229_sub); }

		private static final SyntacticType test_230_sup = parse("{{int}}");
		private static final SyntacticType test_230_sub = parse("{!!any}");
		@Test public void test_230() { testInvalid(test_230_sup,test_230_sub); }

		private static final SyntacticType test_231_sup = parse("{{int}}");
		private static final SyntacticType test_231_sub = parse("{!!int}");
		@Test public void test_231() { testInvalid(test_231_sup,test_231_sub); }

		private static final SyntacticType test_232_sup = parse("{{int}}");
		private static final SyntacticType test_232_sub = parse("!{{any}}");
		@Test public void test_232() { testInvalid(test_232_sup,test_232_sub); }

		private static final SyntacticType test_233_sup = parse("{{int}}");
		private static final SyntacticType test_233_sub = parse("!{{int}}");
		@Test public void test_233() { testInvalid(test_233_sup,test_233_sub); }

		private static final SyntacticType test_234_sup = parse("{{int}}");
		private static final SyntacticType test_234_sub = parse("!{!any}");
		@Test public void test_234() { testInvalid(test_234_sup,test_234_sub); }

		private static final SyntacticType test_235_sup = parse("{{int}}");
		private static final SyntacticType test_235_sub = parse("!{!int}");
		@Test public void test_235() { testInvalid(test_235_sup,test_235_sub); }

		private static final SyntacticType test_236_sup = parse("{{int}}");
		private static final SyntacticType test_236_sub = parse("!!{any}");
		@Test public void test_236() { testInvalid(test_236_sup,test_236_sub); }

		private static final SyntacticType test_237_sup = parse("{{int}}");
		private static final SyntacticType test_237_sub = parse("!!{int}");
		@Test public void test_237() { testInvalid(test_237_sup,test_237_sub); }

		private static final SyntacticType test_238_sup = parse("{{int}}");
		private static final SyntacticType test_238_sub = parse("!!!any");
		@Test public void test_238() { testValid(test_238_sup,test_238_sub); }

		private static final SyntacticType test_239_sup = parse("{{int}}");
		private static final SyntacticType test_239_sub = parse("!!!int");
		@Test public void test_239() { testInvalid(test_239_sup,test_239_sub); }

		private static final SyntacticType test_240_sup = parse("{!any}");
		private static final SyntacticType test_240_sub = parse("any");
		@Test public void test_240() { testInvalid(test_240_sup,test_240_sub); }

		private static final SyntacticType test_241_sup = parse("{!any}");
		private static final SyntacticType test_241_sub = parse("int");
		@Test public void test_241() { testInvalid(test_241_sup,test_241_sub); }

		private static final SyntacticType test_242_sup = parse("{!any}");
		private static final SyntacticType test_242_sub = parse("{any}");
		@Test public void test_242() { testInvalid(test_242_sup,test_242_sub); }

		private static final SyntacticType test_243_sup = parse("{!any}");
		private static final SyntacticType test_243_sub = parse("{int}");
		@Test public void test_243() { testInvalid(test_243_sup,test_243_sub); }

		private static final SyntacticType test_244_sup = parse("{!any}");
		private static final SyntacticType test_244_sub = parse("!any");
		@Test public void test_244() { testValid(test_244_sup,test_244_sub); }

		private static final SyntacticType test_245_sup = parse("{!any}");
		private static final SyntacticType test_245_sub = parse("!int");
		@Test public void test_245() { testInvalid(test_245_sup,test_245_sub); }

		private static final SyntacticType test_246_sup = parse("{!any}");
		private static final SyntacticType test_246_sub = parse("{{any}}");
		@Test public void test_246() { testInvalid(test_246_sup,test_246_sub); }

		private static final SyntacticType test_247_sup = parse("{!any}");
		private static final SyntacticType test_247_sub = parse("{{int}}");
		@Test public void test_247() { testInvalid(test_247_sup,test_247_sub); }

		private static final SyntacticType test_248_sup = parse("{!any}");
		private static final SyntacticType test_248_sub = parse("{!any}");
		@Test public void test_248() { testValid(test_248_sup,test_248_sub); }

		private static final SyntacticType test_249_sup = parse("{!any}");
		private static final SyntacticType test_249_sub = parse("{!int}");
		@Test public void test_249() { testInvalid(test_249_sup,test_249_sub); }

		private static final SyntacticType test_250_sup = parse("{!any}");
		private static final SyntacticType test_250_sub = parse("!{any}");
		@Test public void test_250() { testInvalid(test_250_sup,test_250_sub); }

		private static final SyntacticType test_251_sup = parse("{!any}");
		private static final SyntacticType test_251_sub = parse("!{int}");
		@Test public void test_251() { testInvalid(test_251_sup,test_251_sub); }

		private static final SyntacticType test_252_sup = parse("{!any}");
		private static final SyntacticType test_252_sub = parse("!!any");
		@Test public void test_252() { testInvalid(test_252_sup,test_252_sub); }

		private static final SyntacticType test_253_sup = parse("{!any}");
		private static final SyntacticType test_253_sub = parse("!!int");
		@Test public void test_253() { testInvalid(test_253_sup,test_253_sub); }

		private static final SyntacticType test_254_sup = parse("{!any}");
		private static final SyntacticType test_254_sub = parse("{{{any}}}");
		@Test public void test_254() { testInvalid(test_254_sup,test_254_sub); }

		private static final SyntacticType test_255_sup = parse("{!any}");
		private static final SyntacticType test_255_sub = parse("{{{int}}}");
		@Test public void test_255() { testInvalid(test_255_sup,test_255_sub); }

		private static final SyntacticType test_256_sup = parse("{!any}");
		private static final SyntacticType test_256_sub = parse("{{!any}}");
		@Test public void test_256() { testValid(test_256_sup,test_256_sub); }

		private static final SyntacticType test_257_sup = parse("{!any}");
		private static final SyntacticType test_257_sub = parse("{{!int}}");
		@Test public void test_257() { testInvalid(test_257_sup,test_257_sub); }

		private static final SyntacticType test_258_sup = parse("{!any}");
		private static final SyntacticType test_258_sub = parse("{!{any}}");
		@Test public void test_258() { testInvalid(test_258_sup,test_258_sub); }

		private static final SyntacticType test_259_sup = parse("{!any}");
		private static final SyntacticType test_259_sub = parse("{!{int}}");
		@Test public void test_259() { testInvalid(test_259_sup,test_259_sub); }

		private static final SyntacticType test_260_sup = parse("{!any}");
		private static final SyntacticType test_260_sub = parse("{!!any}");
		@Test public void test_260() { testInvalid(test_260_sup,test_260_sub); }

		private static final SyntacticType test_261_sup = parse("{!any}");
		private static final SyntacticType test_261_sub = parse("{!!int}");
		@Test public void test_261() { testInvalid(test_261_sup,test_261_sub); }

		private static final SyntacticType test_262_sup = parse("{!any}");
		private static final SyntacticType test_262_sub = parse("!{{any}}");
		@Test public void test_262() { testInvalid(test_262_sup,test_262_sub); }

		private static final SyntacticType test_263_sup = parse("{!any}");
		private static final SyntacticType test_263_sub = parse("!{{int}}");
		@Test public void test_263() { testInvalid(test_263_sup,test_263_sub); }

		private static final SyntacticType test_264_sup = parse("{!any}");
		private static final SyntacticType test_264_sub = parse("!{!any}");
		@Test public void test_264() { testInvalid(test_264_sup,test_264_sub); }

		private static final SyntacticType test_265_sup = parse("{!any}");
		private static final SyntacticType test_265_sub = parse("!{!int}");
		@Test public void test_265() { testInvalid(test_265_sup,test_265_sub); }

		private static final SyntacticType test_266_sup = parse("{!any}");
		private static final SyntacticType test_266_sub = parse("!!{any}");
		@Test public void test_266() { testInvalid(test_266_sup,test_266_sub); }

		private static final SyntacticType test_267_sup = parse("{!any}");
		private static final SyntacticType test_267_sub = parse("!!{int}");
		@Test public void test_267() { testInvalid(test_267_sup,test_267_sub); }

		private static final SyntacticType test_268_sup = parse("{!any}");
		private static final SyntacticType test_268_sub = parse("!!!any");
		@Test public void test_268() { testValid(test_268_sup,test_268_sub); }

		private static final SyntacticType test_269_sup = parse("{!any}");
		private static final SyntacticType test_269_sub = parse("!!!int");
		@Test public void test_269() { testInvalid(test_269_sup,test_269_sub); }

		private static final SyntacticType test_270_sup = parse("{!int}");
		private static final SyntacticType test_270_sub = parse("any");
		@Test public void test_270() { testInvalid(test_270_sup,test_270_sub); }

		private static final SyntacticType test_271_sup = parse("{!int}");
		private static final SyntacticType test_271_sub = parse("int");
		@Test public void test_271() { testInvalid(test_271_sup,test_271_sub); }

		private static final SyntacticType test_272_sup = parse("{!int}");
		private static final SyntacticType test_272_sub = parse("{any}");
		@Test public void test_272() { testInvalid(test_272_sup,test_272_sub); }

		private static final SyntacticType test_273_sup = parse("{!int}");
		private static final SyntacticType test_273_sub = parse("{int}");
		@Test public void test_273() { testInvalid(test_273_sup,test_273_sub); }

		private static final SyntacticType test_274_sup = parse("{!int}");
		private static final SyntacticType test_274_sub = parse("!any");
		@Test public void test_274() { testValid(test_274_sup,test_274_sub); }

		private static final SyntacticType test_275_sup = parse("{!int}");
		private static final SyntacticType test_275_sub = parse("!int");
		@Test public void test_275() { testInvalid(test_275_sup,test_275_sub); }

		private static final SyntacticType test_276_sup = parse("{!int}");
		private static final SyntacticType test_276_sub = parse("{{any}}");
		@Test public void test_276() { testValid(test_276_sup,test_276_sub); }

		private static final SyntacticType test_277_sup = parse("{!int}");
		private static final SyntacticType test_277_sub = parse("{{int}}");
		@Test public void test_277() { testValid(test_277_sup,test_277_sub); }

		private static final SyntacticType test_278_sup = parse("{!int}");
		private static final SyntacticType test_278_sub = parse("{!any}");
		@Test public void test_278() { testValid(test_278_sup,test_278_sub); }

		private static final SyntacticType test_279_sup = parse("{!int}");
		private static final SyntacticType test_279_sub = parse("{!int}");
		@Test public void test_279() { testValid(test_279_sup,test_279_sub); }

		private static final SyntacticType test_280_sup = parse("{!int}");
		private static final SyntacticType test_280_sub = parse("!{any}");
		@Test public void test_280() { testInvalid(test_280_sup,test_280_sub); }

		private static final SyntacticType test_281_sup = parse("{!int}");
		private static final SyntacticType test_281_sub = parse("!{int}");
		@Test public void test_281() { testInvalid(test_281_sup,test_281_sub); }

		private static final SyntacticType test_282_sup = parse("{!int}");
		private static final SyntacticType test_282_sub = parse("!!any");
		@Test public void test_282() { testInvalid(test_282_sup,test_282_sub); }

		private static final SyntacticType test_283_sup = parse("{!int}");
		private static final SyntacticType test_283_sub = parse("!!int");
		@Test public void test_283() { testInvalid(test_283_sup,test_283_sub); }

		private static final SyntacticType test_284_sup = parse("{!int}");
		private static final SyntacticType test_284_sub = parse("{{{any}}}");
		@Test public void test_284() { testValid(test_284_sup,test_284_sub); }

		private static final SyntacticType test_285_sup = parse("{!int}");
		private static final SyntacticType test_285_sub = parse("{{{int}}}");
		@Test public void test_285() { testValid(test_285_sup,test_285_sub); }

		private static final SyntacticType test_286_sup = parse("{!int}");
		private static final SyntacticType test_286_sub = parse("{{!any}}");
		@Test public void test_286() { testValid(test_286_sup,test_286_sub); }

		private static final SyntacticType test_287_sup = parse("{!int}");
		private static final SyntacticType test_287_sub = parse("{{!int}}");
		@Test public void test_287() { testValid(test_287_sup,test_287_sub); }

		private static final SyntacticType test_288_sup = parse("{!int}");
		private static final SyntacticType test_288_sub = parse("{!{any}}");
		@Test public void test_288() { testInvalid(test_288_sup,test_288_sub); }

		private static final SyntacticType test_289_sup = parse("{!int}");
		private static final SyntacticType test_289_sub = parse("{!{int}}");
		@Test public void test_289() { testInvalid(test_289_sup,test_289_sub); }

		private static final SyntacticType test_290_sup = parse("{!int}");
		private static final SyntacticType test_290_sub = parse("{!!any}");
		@Test public void test_290() { testInvalid(test_290_sup,test_290_sub); }

		private static final SyntacticType test_291_sup = parse("{!int}");
		private static final SyntacticType test_291_sub = parse("{!!int}");
		@Test public void test_291() { testInvalid(test_291_sup,test_291_sub); }

		private static final SyntacticType test_292_sup = parse("{!int}");
		private static final SyntacticType test_292_sub = parse("!{{any}}");
		@Test public void test_292() { testInvalid(test_292_sup,test_292_sub); }

		private static final SyntacticType test_293_sup = parse("{!int}");
		private static final SyntacticType test_293_sub = parse("!{{int}}");
		@Test public void test_293() { testInvalid(test_293_sup,test_293_sub); }

		private static final SyntacticType test_294_sup = parse("{!int}");
		private static final SyntacticType test_294_sub = parse("!{!any}");
		@Test public void test_294() { testInvalid(test_294_sup,test_294_sub); }

		private static final SyntacticType test_295_sup = parse("{!int}");
		private static final SyntacticType test_295_sub = parse("!{!int}");
		@Test public void test_295() { testInvalid(test_295_sup,test_295_sub); }

		private static final SyntacticType test_296_sup = parse("{!int}");
		private static final SyntacticType test_296_sub = parse("!!{any}");
		@Test public void test_296() { testInvalid(test_296_sup,test_296_sub); }

		private static final SyntacticType test_297_sup = parse("{!int}");
		private static final SyntacticType test_297_sub = parse("!!{int}");
		@Test public void test_297() { testInvalid(test_297_sup,test_297_sub); }

		private static final SyntacticType test_298_sup = parse("{!int}");
		private static final SyntacticType test_298_sub = parse("!!!any");
		@Test public void test_298() { testValid(test_298_sup,test_298_sub); }

		private static final SyntacticType test_299_sup = parse("{!int}");
		private static final SyntacticType test_299_sub = parse("!!!int");
		@Test public void test_299() { testInvalid(test_299_sup,test_299_sub); }

		private static final SyntacticType test_300_sup = parse("!{any}");
		private static final SyntacticType test_300_sub = parse("any");
		@Test public void test_300() { testInvalid(test_300_sup,test_300_sub); }

		private static final SyntacticType test_301_sup = parse("!{any}");
		private static final SyntacticType test_301_sub = parse("int");
		@Test public void test_301() { testValid(test_301_sup,test_301_sub); }

		private static final SyntacticType test_302_sup = parse("!{any}");
		private static final SyntacticType test_302_sub = parse("{any}");
		@Test public void test_302() { testInvalid(test_302_sup,test_302_sub); }

		private static final SyntacticType test_303_sup = parse("!{any}");
		private static final SyntacticType test_303_sub = parse("{int}");
		@Test public void test_303() { testInvalid(test_303_sup,test_303_sub); }

		private static final SyntacticType test_304_sup = parse("!{any}");
		private static final SyntacticType test_304_sub = parse("!any");
		@Test public void test_304() { testValid(test_304_sup,test_304_sub); }

		private static final SyntacticType test_305_sup = parse("!{any}");
		private static final SyntacticType test_305_sub = parse("!int");
		@Test public void test_305() { testInvalid(test_305_sup,test_305_sub); }

		private static final SyntacticType test_306_sup = parse("!{any}");
		private static final SyntacticType test_306_sub = parse("{{any}}");
		@Test public void test_306() { testInvalid(test_306_sup,test_306_sub); }

		private static final SyntacticType test_307_sup = parse("!{any}");
		private static final SyntacticType test_307_sub = parse("{{int}}");
		@Test public void test_307() { testInvalid(test_307_sup,test_307_sub); }

		private static final SyntacticType test_308_sup = parse("!{any}");
		private static final SyntacticType test_308_sub = parse("{!any}");
		@Test public void test_308() { testValid(test_308_sup,test_308_sub); }

		private static final SyntacticType test_309_sup = parse("!{any}");
		private static final SyntacticType test_309_sub = parse("{!int}");
		@Test public void test_309() { testInvalid(test_309_sup,test_309_sub); }

		private static final SyntacticType test_310_sup = parse("!{any}");
		private static final SyntacticType test_310_sub = parse("!{any}");
		@Test public void test_310() { testValid(test_310_sup,test_310_sub); }

		private static final SyntacticType test_311_sup = parse("!{any}");
		private static final SyntacticType test_311_sub = parse("!{int}");
		@Test public void test_311() { testInvalid(test_311_sup,test_311_sub); }

		private static final SyntacticType test_312_sup = parse("!{any}");
		private static final SyntacticType test_312_sub = parse("!!any");
		@Test public void test_312() { testInvalid(test_312_sup,test_312_sub); }

		private static final SyntacticType test_313_sup = parse("!{any}");
		private static final SyntacticType test_313_sub = parse("!!int");
		@Test public void test_313() { testValid(test_313_sup,test_313_sub); }

		private static final SyntacticType test_314_sup = parse("!{any}");
		private static final SyntacticType test_314_sub = parse("{{{any}}}");
		@Test public void test_314() { testInvalid(test_314_sup,test_314_sub); }

		private static final SyntacticType test_315_sup = parse("!{any}");
		private static final SyntacticType test_315_sub = parse("{{{int}}}");
		@Test public void test_315() { testInvalid(test_315_sup,test_315_sub); }

		private static final SyntacticType test_316_sup = parse("!{any}");
		private static final SyntacticType test_316_sub = parse("{{!any}}");
		@Test public void test_316() { testValid(test_316_sup,test_316_sub); }

		private static final SyntacticType test_317_sup = parse("!{any}");
		private static final SyntacticType test_317_sub = parse("{{!int}}");
		@Test public void test_317() { testInvalid(test_317_sup,test_317_sub); }

		private static final SyntacticType test_318_sup = parse("!{any}");
		private static final SyntacticType test_318_sub = parse("{!{any}}");
		@Test public void test_318() { testInvalid(test_318_sup,test_318_sub); }

		private static final SyntacticType test_319_sup = parse("!{any}");
		private static final SyntacticType test_319_sub = parse("{!{int}}");
		@Test public void test_319() { testInvalid(test_319_sup,test_319_sub); }

		private static final SyntacticType test_320_sup = parse("!{any}");
		private static final SyntacticType test_320_sub = parse("{!!any}");
		@Test public void test_320() { testInvalid(test_320_sup,test_320_sub); }

		private static final SyntacticType test_321_sup = parse("!{any}");
		private static final SyntacticType test_321_sub = parse("{!!int}");
		@Test public void test_321() { testInvalid(test_321_sup,test_321_sub); }

		private static final SyntacticType test_322_sup = parse("!{any}");
		private static final SyntacticType test_322_sub = parse("!{{any}}");
		@Test public void test_322() { testInvalid(test_322_sup,test_322_sub); }

		private static final SyntacticType test_323_sup = parse("!{any}");
		private static final SyntacticType test_323_sub = parse("!{{int}}");
		@Test public void test_323() { testInvalid(test_323_sup,test_323_sub); }

		private static final SyntacticType test_324_sup = parse("!{any}");
		private static final SyntacticType test_324_sub = parse("!{!any}");
		@Test public void test_324() { testInvalid(test_324_sup,test_324_sub); }

		private static final SyntacticType test_325_sup = parse("!{any}");
		private static final SyntacticType test_325_sub = parse("!{!int}");
		@Test public void test_325() { testInvalid(test_325_sup,test_325_sub); }

		private static final SyntacticType test_326_sup = parse("!{any}");
		private static final SyntacticType test_326_sub = parse("!!{any}");
		@Test public void test_326() { testInvalid(test_326_sup,test_326_sub); }

		private static final SyntacticType test_327_sup = parse("!{any}");
		private static final SyntacticType test_327_sub = parse("!!{int}");
		@Test public void test_327() { testInvalid(test_327_sup,test_327_sub); }

		private static final SyntacticType test_328_sup = parse("!{any}");
		private static final SyntacticType test_328_sub = parse("!!!any");
		@Test public void test_328() { testValid(test_328_sup,test_328_sub); }

		private static final SyntacticType test_329_sup = parse("!{any}");
		private static final SyntacticType test_329_sub = parse("!!!int");
		@Test public void test_329() { testInvalid(test_329_sup,test_329_sub); }

		private static final SyntacticType test_330_sup = parse("!{int}");
		private static final SyntacticType test_330_sub = parse("any");
		@Test public void test_330() { testInvalid(test_330_sup,test_330_sub); }

		private static final SyntacticType test_331_sup = parse("!{int}");
		private static final SyntacticType test_331_sub = parse("int");
		@Test public void test_331() { testValid(test_331_sup,test_331_sub); }

		private static final SyntacticType test_332_sup = parse("!{int}");
		private static final SyntacticType test_332_sub = parse("{any}");
		@Test public void test_332() { testInvalid(test_332_sup,test_332_sub); }

		private static final SyntacticType test_333_sup = parse("!{int}");
		private static final SyntacticType test_333_sub = parse("{int}");
		@Test public void test_333() { testInvalid(test_333_sup,test_333_sub); }

		private static final SyntacticType test_334_sup = parse("!{int}");
		private static final SyntacticType test_334_sub = parse("!any");
		@Test public void test_334() { testValid(test_334_sup,test_334_sub); }

		private static final SyntacticType test_335_sup = parse("!{int}");
		private static final SyntacticType test_335_sub = parse("!int");
		@Test public void test_335() { testInvalid(test_335_sup,test_335_sub); }

		private static final SyntacticType test_336_sup = parse("!{int}");
		private static final SyntacticType test_336_sub = parse("{{any}}");
		@Test public void test_336() { testValid(test_336_sup,test_336_sub); }

		private static final SyntacticType test_337_sup = parse("!{int}");
		private static final SyntacticType test_337_sub = parse("{{int}}");
		@Test public void test_337() { testValid(test_337_sup,test_337_sub); }

		private static final SyntacticType test_338_sup = parse("!{int}");
		private static final SyntacticType test_338_sub = parse("{!any}");
		@Test public void test_338() { testValid(test_338_sup,test_338_sub); }

		private static final SyntacticType test_339_sup = parse("!{int}");
		private static final SyntacticType test_339_sub = parse("{!int}");
		@Test public void test_339() { testValid(test_339_sup,test_339_sub); }

		private static final SyntacticType test_340_sup = parse("!{int}");
		private static final SyntacticType test_340_sub = parse("!{any}");
		@Test public void test_340() { testValid(test_340_sup,test_340_sub); }

		private static final SyntacticType test_341_sup = parse("!{int}");
		private static final SyntacticType test_341_sub = parse("!{int}");
		@Test public void test_341() { testValid(test_341_sup,test_341_sub); }

		private static final SyntacticType test_342_sup = parse("!{int}");
		private static final SyntacticType test_342_sub = parse("!!any");
		@Test public void test_342() { testInvalid(test_342_sup,test_342_sub); }

		private static final SyntacticType test_343_sup = parse("!{int}");
		private static final SyntacticType test_343_sub = parse("!!int");
		@Test public void test_343() { testValid(test_343_sup,test_343_sub); }

		private static final SyntacticType test_344_sup = parse("!{int}");
		private static final SyntacticType test_344_sub = parse("{{{any}}}");
		@Test public void test_344() { testValid(test_344_sup,test_344_sub); }

		private static final SyntacticType test_345_sup = parse("!{int}");
		private static final SyntacticType test_345_sub = parse("{{{int}}}");
		@Test public void test_345() { testValid(test_345_sup,test_345_sub); }

		private static final SyntacticType test_346_sup = parse("!{int}");
		private static final SyntacticType test_346_sub = parse("{{!any}}");
		@Test public void test_346() { testValid(test_346_sup,test_346_sub); }

		private static final SyntacticType test_347_sup = parse("!{int}");
		private static final SyntacticType test_347_sub = parse("{{!int}}");
		@Test public void test_347() { testValid(test_347_sup,test_347_sub); }

		private static final SyntacticType test_348_sup = parse("!{int}");
		private static final SyntacticType test_348_sub = parse("{!{any}}");
		@Test public void test_348() { testInvalid(test_348_sup,test_348_sub); }

		private static final SyntacticType test_349_sup = parse("!{int}");
		private static final SyntacticType test_349_sub = parse("{!{int}}");
		@Test public void test_349() { testInvalid(test_349_sup,test_349_sub); }

		private static final SyntacticType test_350_sup = parse("!{int}");
		private static final SyntacticType test_350_sub = parse("{!!any}");
		@Test public void test_350() { testInvalid(test_350_sup,test_350_sub); }

		private static final SyntacticType test_351_sup = parse("!{int}");
		private static final SyntacticType test_351_sub = parse("{!!int}");
		@Test public void test_351() { testInvalid(test_351_sup,test_351_sub); }

		private static final SyntacticType test_352_sup = parse("!{int}");
		private static final SyntacticType test_352_sub = parse("!{{any}}");
		@Test public void test_352() { testInvalid(test_352_sup,test_352_sub); }

		private static final SyntacticType test_353_sup = parse("!{int}");
		private static final SyntacticType test_353_sub = parse("!{{int}}");
		@Test public void test_353() { testInvalid(test_353_sup,test_353_sub); }

		private static final SyntacticType test_354_sup = parse("!{int}");
		private static final SyntacticType test_354_sub = parse("!{!any}");
		@Test public void test_354() { testInvalid(test_354_sup,test_354_sub); }

		private static final SyntacticType test_355_sup = parse("!{int}");
		private static final SyntacticType test_355_sub = parse("!{!int}");
		@Test public void test_355() { testInvalid(test_355_sup,test_355_sub); }

		private static final SyntacticType test_356_sup = parse("!{int}");
		private static final SyntacticType test_356_sub = parse("!!{any}");
		@Test public void test_356() { testInvalid(test_356_sup,test_356_sub); }

		private static final SyntacticType test_357_sup = parse("!{int}");
		private static final SyntacticType test_357_sub = parse("!!{int}");
		@Test public void test_357() { testInvalid(test_357_sup,test_357_sub); }

		private static final SyntacticType test_358_sup = parse("!{int}");
		private static final SyntacticType test_358_sub = parse("!!!any");
		@Test public void test_358() { testValid(test_358_sup,test_358_sub); }

		private static final SyntacticType test_359_sup = parse("!{int}");
		private static final SyntacticType test_359_sub = parse("!!!int");
		@Test public void test_359() { testInvalid(test_359_sup,test_359_sub); }

		private static final SyntacticType test_360_sup = parse("!!any");
		private static final SyntacticType test_360_sub = parse("any");
		@Test public void test_360() { testValid(test_360_sup,test_360_sub); }

		private static final SyntacticType test_361_sup = parse("!!any");
		private static final SyntacticType test_361_sub = parse("int");
		@Test public void test_361() { testValid(test_361_sup,test_361_sub); }

		private static final SyntacticType test_362_sup = parse("!!any");
		private static final SyntacticType test_362_sub = parse("{any}");
		@Test public void test_362() { testValid(test_362_sup,test_362_sub); }

		private static final SyntacticType test_363_sup = parse("!!any");
		private static final SyntacticType test_363_sub = parse("{int}");
		@Test public void test_363() { testValid(test_363_sup,test_363_sub); }

		private static final SyntacticType test_364_sup = parse("!!any");
		private static final SyntacticType test_364_sub = parse("!any");
		@Test public void test_364() { testValid(test_364_sup,test_364_sub); }

		private static final SyntacticType test_365_sup = parse("!!any");
		private static final SyntacticType test_365_sub = parse("!int");
		@Test public void test_365() { testValid(test_365_sup,test_365_sub); }

		private static final SyntacticType test_366_sup = parse("!!any");
		private static final SyntacticType test_366_sub = parse("{{any}}");
		@Test public void test_366() { testValid(test_366_sup,test_366_sub); }

		private static final SyntacticType test_367_sup = parse("!!any");
		private static final SyntacticType test_367_sub = parse("{{int}}");
		@Test public void test_367() { testValid(test_367_sup,test_367_sub); }

		private static final SyntacticType test_368_sup = parse("!!any");
		private static final SyntacticType test_368_sub = parse("{!any}");
		@Test public void test_368() { testValid(test_368_sup,test_368_sub); }

		private static final SyntacticType test_369_sup = parse("!!any");
		private static final SyntacticType test_369_sub = parse("{!int}");
		@Test public void test_369() { testValid(test_369_sup,test_369_sub); }

		private static final SyntacticType test_370_sup = parse("!!any");
		private static final SyntacticType test_370_sub = parse("!{any}");
		@Test public void test_370() { testValid(test_370_sup,test_370_sub); }

		private static final SyntacticType test_371_sup = parse("!!any");
		private static final SyntacticType test_371_sub = parse("!{int}");
		@Test public void test_371() { testValid(test_371_sup,test_371_sub); }

		private static final SyntacticType test_372_sup = parse("!!any");
		private static final SyntacticType test_372_sub = parse("!!any");
		@Test public void test_372() { testValid(test_372_sup,test_372_sub); }

		private static final SyntacticType test_373_sup = parse("!!any");
		private static final SyntacticType test_373_sub = parse("!!int");
		@Test public void test_373() { testValid(test_373_sup,test_373_sub); }

		private static final SyntacticType test_374_sup = parse("!!any");
		private static final SyntacticType test_374_sub = parse("{{{any}}}");
		@Test public void test_374() { testValid(test_374_sup,test_374_sub); }

		private static final SyntacticType test_375_sup = parse("!!any");
		private static final SyntacticType test_375_sub = parse("{{{int}}}");
		@Test public void test_375() { testValid(test_375_sup,test_375_sub); }

		private static final SyntacticType test_376_sup = parse("!!any");
		private static final SyntacticType test_376_sub = parse("{{!any}}");
		@Test public void test_376() { testValid(test_376_sup,test_376_sub); }

		private static final SyntacticType test_377_sup = parse("!!any");
		private static final SyntacticType test_377_sub = parse("{{!int}}");
		@Test public void test_377() { testValid(test_377_sup,test_377_sub); }

		private static final SyntacticType test_378_sup = parse("!!any");
		private static final SyntacticType test_378_sub = parse("{!{any}}");
		@Test public void test_378() { testValid(test_378_sup,test_378_sub); }

		private static final SyntacticType test_379_sup = parse("!!any");
		private static final SyntacticType test_379_sub = parse("{!{int}}");
		@Test public void test_379() { testValid(test_379_sup,test_379_sub); }

		private static final SyntacticType test_380_sup = parse("!!any");
		private static final SyntacticType test_380_sub = parse("{!!any}");
		@Test public void test_380() { testValid(test_380_sup,test_380_sub); }

		private static final SyntacticType test_381_sup = parse("!!any");
		private static final SyntacticType test_381_sub = parse("{!!int}");
		@Test public void test_381() { testValid(test_381_sup,test_381_sub); }

		private static final SyntacticType test_382_sup = parse("!!any");
		private static final SyntacticType test_382_sub = parse("!{{any}}");
		@Test public void test_382() { testValid(test_382_sup,test_382_sub); }

		private static final SyntacticType test_383_sup = parse("!!any");
		private static final SyntacticType test_383_sub = parse("!{{int}}");
		@Test public void test_383() { testValid(test_383_sup,test_383_sub); }

		private static final SyntacticType test_384_sup = parse("!!any");
		private static final SyntacticType test_384_sub = parse("!{!any}");
		@Test public void test_384() { testValid(test_384_sup,test_384_sub); }

		private static final SyntacticType test_385_sup = parse("!!any");
		private static final SyntacticType test_385_sub = parse("!{!int}");
		@Test public void test_385() { testValid(test_385_sup,test_385_sub); }

		private static final SyntacticType test_386_sup = parse("!!any");
		private static final SyntacticType test_386_sub = parse("!!{any}");
		@Test public void test_386() { testValid(test_386_sup,test_386_sub); }

		private static final SyntacticType test_387_sup = parse("!!any");
		private static final SyntacticType test_387_sub = parse("!!{int}");
		@Test public void test_387() { testValid(test_387_sup,test_387_sub); }

		private static final SyntacticType test_388_sup = parse("!!any");
		private static final SyntacticType test_388_sub = parse("!!!any");
		@Test public void test_388() { testValid(test_388_sup,test_388_sub); }

		private static final SyntacticType test_389_sup = parse("!!any");
		private static final SyntacticType test_389_sub = parse("!!!int");
		@Test public void test_389() { testValid(test_389_sup,test_389_sub); }

		private static final SyntacticType test_390_sup = parse("!!int");
		private static final SyntacticType test_390_sub = parse("any");
		@Test public void test_390() { testInvalid(test_390_sup,test_390_sub); }

		private static final SyntacticType test_391_sup = parse("!!int");
		private static final SyntacticType test_391_sub = parse("int");
		@Test public void test_391() { testValid(test_391_sup,test_391_sub); }

		private static final SyntacticType test_392_sup = parse("!!int");
		private static final SyntacticType test_392_sub = parse("{any}");
		@Test public void test_392() { testInvalid(test_392_sup,test_392_sub); }

		private static final SyntacticType test_393_sup = parse("!!int");
		private static final SyntacticType test_393_sub = parse("{int}");
		@Test public void test_393() { testInvalid(test_393_sup,test_393_sub); }

		private static final SyntacticType test_394_sup = parse("!!int");
		private static final SyntacticType test_394_sub = parse("!any");
		@Test public void test_394() { testValid(test_394_sup,test_394_sub); }

		private static final SyntacticType test_395_sup = parse("!!int");
		private static final SyntacticType test_395_sub = parse("!int");
		@Test public void test_395() { testInvalid(test_395_sup,test_395_sub); }

		private static final SyntacticType test_396_sup = parse("!!int");
		private static final SyntacticType test_396_sub = parse("{{any}}");
		@Test public void test_396() { testInvalid(test_396_sup,test_396_sub); }

		private static final SyntacticType test_397_sup = parse("!!int");
		private static final SyntacticType test_397_sub = parse("{{int}}");
		@Test public void test_397() { testInvalid(test_397_sup,test_397_sub); }

		private static final SyntacticType test_398_sup = parse("!!int");
		private static final SyntacticType test_398_sub = parse("{!any}");
		@Test public void test_398() { testValid(test_398_sup,test_398_sub); }

		private static final SyntacticType test_399_sup = parse("!!int");
		private static final SyntacticType test_399_sub = parse("{!int}");
		@Test public void test_399() { testInvalid(test_399_sup,test_399_sub); }

		private static final SyntacticType test_400_sup = parse("!!int");
		private static final SyntacticType test_400_sub = parse("!{any}");
		@Test public void test_400() { testInvalid(test_400_sup,test_400_sub); }

		private static final SyntacticType test_401_sup = parse("!!int");
		private static final SyntacticType test_401_sub = parse("!{int}");
		@Test public void test_401() { testInvalid(test_401_sup,test_401_sub); }

		private static final SyntacticType test_402_sup = parse("!!int");
		private static final SyntacticType test_402_sub = parse("!!any");
		@Test public void test_402() { testInvalid(test_402_sup,test_402_sub); }

		private static final SyntacticType test_403_sup = parse("!!int");
		private static final SyntacticType test_403_sub = parse("!!int");
		@Test public void test_403() { testValid(test_403_sup,test_403_sub); }

		private static final SyntacticType test_404_sup = parse("!!int");
		private static final SyntacticType test_404_sub = parse("{{{any}}}");
		@Test public void test_404() { testInvalid(test_404_sup,test_404_sub); }

		private static final SyntacticType test_405_sup = parse("!!int");
		private static final SyntacticType test_405_sub = parse("{{{int}}}");
		@Test public void test_405() { testInvalid(test_405_sup,test_405_sub); }

		private static final SyntacticType test_406_sup = parse("!!int");
		private static final SyntacticType test_406_sub = parse("{{!any}}");
		@Test public void test_406() { testValid(test_406_sup,test_406_sub); }

		private static final SyntacticType test_407_sup = parse("!!int");
		private static final SyntacticType test_407_sub = parse("{{!int}}");
		@Test public void test_407() { testInvalid(test_407_sup,test_407_sub); }

		private static final SyntacticType test_408_sup = parse("!!int");
		private static final SyntacticType test_408_sub = parse("{!{any}}");
		@Test public void test_408() { testInvalid(test_408_sup,test_408_sub); }

		private static final SyntacticType test_409_sup = parse("!!int");
		private static final SyntacticType test_409_sub = parse("{!{int}}");
		@Test public void test_409() { testInvalid(test_409_sup,test_409_sub); }

		private static final SyntacticType test_410_sup = parse("!!int");
		private static final SyntacticType test_410_sub = parse("{!!any}");
		@Test public void test_410() { testInvalid(test_410_sup,test_410_sub); }

		private static final SyntacticType test_411_sup = parse("!!int");
		private static final SyntacticType test_411_sub = parse("{!!int}");
		@Test public void test_411() { testInvalid(test_411_sup,test_411_sub); }

		private static final SyntacticType test_412_sup = parse("!!int");
		private static final SyntacticType test_412_sub = parse("!{{any}}");
		@Test public void test_412() { testInvalid(test_412_sup,test_412_sub); }

		private static final SyntacticType test_413_sup = parse("!!int");
		private static final SyntacticType test_413_sub = parse("!{{int}}");
		@Test public void test_413() { testInvalid(test_413_sup,test_413_sub); }

		private static final SyntacticType test_414_sup = parse("!!int");
		private static final SyntacticType test_414_sub = parse("!{!any}");
		@Test public void test_414() { testInvalid(test_414_sup,test_414_sub); }

		private static final SyntacticType test_415_sup = parse("!!int");
		private static final SyntacticType test_415_sub = parse("!{!int}");
		@Test public void test_415() { testInvalid(test_415_sup,test_415_sub); }

		private static final SyntacticType test_416_sup = parse("!!int");
		private static final SyntacticType test_416_sub = parse("!!{any}");
		@Test public void test_416() { testInvalid(test_416_sup,test_416_sub); }

		private static final SyntacticType test_417_sup = parse("!!int");
		private static final SyntacticType test_417_sub = parse("!!{int}");
		@Test public void test_417() { testInvalid(test_417_sup,test_417_sub); }

		private static final SyntacticType test_418_sup = parse("!!int");
		private static final SyntacticType test_418_sub = parse("!!!any");
		@Test public void test_418() { testValid(test_418_sup,test_418_sub); }

		private static final SyntacticType test_419_sup = parse("!!int");
		private static final SyntacticType test_419_sub = parse("!!!int");
		@Test public void test_419() { testInvalid(test_419_sup,test_419_sub); }

		private static final SyntacticType test_420_sup = parse("{{{any}}}");
		private static final SyntacticType test_420_sub = parse("any");
		@Test public void test_420() { testInvalid(test_420_sup,test_420_sub); }

		private static final SyntacticType test_421_sup = parse("{{{any}}}");
		private static final SyntacticType test_421_sub = parse("int");
		@Test public void test_421() { testInvalid(test_421_sup,test_421_sub); }

		private static final SyntacticType test_422_sup = parse("{{{any}}}");
		private static final SyntacticType test_422_sub = parse("{any}");
		@Test public void test_422() { testInvalid(test_422_sup,test_422_sub); }

		private static final SyntacticType test_423_sup = parse("{{{any}}}");
		private static final SyntacticType test_423_sub = parse("{int}");
		@Test public void test_423() { testInvalid(test_423_sup,test_423_sub); }

		private static final SyntacticType test_424_sup = parse("{{{any}}}");
		private static final SyntacticType test_424_sub = parse("!any");
		@Test public void test_424() { testValid(test_424_sup,test_424_sub); }

		private static final SyntacticType test_425_sup = parse("{{{any}}}");
		private static final SyntacticType test_425_sub = parse("!int");
		@Test public void test_425() { testInvalid(test_425_sup,test_425_sub); }

		private static final SyntacticType test_426_sup = parse("{{{any}}}");
		private static final SyntacticType test_426_sub = parse("{{any}}");
		@Test public void test_426() { testInvalid(test_426_sup,test_426_sub); }

		private static final SyntacticType test_427_sup = parse("{{{any}}}");
		private static final SyntacticType test_427_sub = parse("{{int}}");
		@Test public void test_427() { testInvalid(test_427_sup,test_427_sub); }

		private static final SyntacticType test_428_sup = parse("{{{any}}}");
		private static final SyntacticType test_428_sub = parse("{!any}");
		@Test public void test_428() { testValid(test_428_sup,test_428_sub); }

		private static final SyntacticType test_429_sup = parse("{{{any}}}");
		private static final SyntacticType test_429_sub = parse("{!int}");
		@Test public void test_429() { testInvalid(test_429_sup,test_429_sub); }

		private static final SyntacticType test_430_sup = parse("{{{any}}}");
		private static final SyntacticType test_430_sub = parse("!{any}");
		@Test public void test_430() { testInvalid(test_430_sup,test_430_sub); }

		private static final SyntacticType test_431_sup = parse("{{{any}}}");
		private static final SyntacticType test_431_sub = parse("!{int}");
		@Test public void test_431() { testInvalid(test_431_sup,test_431_sub); }

		private static final SyntacticType test_432_sup = parse("{{{any}}}");
		private static final SyntacticType test_432_sub = parse("!!any");
		@Test public void test_432() { testInvalid(test_432_sup,test_432_sub); }

		private static final SyntacticType test_433_sup = parse("{{{any}}}");
		private static final SyntacticType test_433_sub = parse("!!int");
		@Test public void test_433() { testInvalid(test_433_sup,test_433_sub); }

		private static final SyntacticType test_434_sup = parse("{{{any}}}");
		private static final SyntacticType test_434_sub = parse("{{{any}}}");
		@Test public void test_434() { testValid(test_434_sup,test_434_sub); }

		private static final SyntacticType test_435_sup = parse("{{{any}}}");
		private static final SyntacticType test_435_sub = parse("{{{int}}}");
		@Test public void test_435() { testValid(test_435_sup,test_435_sub); }

		private static final SyntacticType test_436_sup = parse("{{{any}}}");
		private static final SyntacticType test_436_sub = parse("{{!any}}");
		@Test public void test_436() { testValid(test_436_sup,test_436_sub); }

		private static final SyntacticType test_437_sup = parse("{{{any}}}");
		private static final SyntacticType test_437_sub = parse("{{!int}}");
		@Test public void test_437() { testInvalid(test_437_sup,test_437_sub); }

		private static final SyntacticType test_438_sup = parse("{{{any}}}");
		private static final SyntacticType test_438_sub = parse("{!{any}}");
		@Test public void test_438() { testInvalid(test_438_sup,test_438_sub); }

		private static final SyntacticType test_439_sup = parse("{{{any}}}");
		private static final SyntacticType test_439_sub = parse("{!{int}}");
		@Test public void test_439() { testInvalid(test_439_sup,test_439_sub); }

		private static final SyntacticType test_440_sup = parse("{{{any}}}");
		private static final SyntacticType test_440_sub = parse("{!!any}");
		@Test public void test_440() { testInvalid(test_440_sup,test_440_sub); }

		private static final SyntacticType test_441_sup = parse("{{{any}}}");
		private static final SyntacticType test_441_sub = parse("{!!int}");
		@Test public void test_441() { testInvalid(test_441_sup,test_441_sub); }

		private static final SyntacticType test_442_sup = parse("{{{any}}}");
		private static final SyntacticType test_442_sub = parse("!{{any}}");
		@Test public void test_442() { testInvalid(test_442_sup,test_442_sub); }

		private static final SyntacticType test_443_sup = parse("{{{any}}}");
		private static final SyntacticType test_443_sub = parse("!{{int}}");
		@Test public void test_443() { testInvalid(test_443_sup,test_443_sub); }

		private static final SyntacticType test_444_sup = parse("{{{any}}}");
		private static final SyntacticType test_444_sub = parse("!{!any}");
		@Test public void test_444() { testInvalid(test_444_sup,test_444_sub); }

		private static final SyntacticType test_445_sup = parse("{{{any}}}");
		private static final SyntacticType test_445_sub = parse("!{!int}");
		@Test public void test_445() { testInvalid(test_445_sup,test_445_sub); }

		private static final SyntacticType test_446_sup = parse("{{{any}}}");
		private static final SyntacticType test_446_sub = parse("!!{any}");
		@Test public void test_446() { testInvalid(test_446_sup,test_446_sub); }

		private static final SyntacticType test_447_sup = parse("{{{any}}}");
		private static final SyntacticType test_447_sub = parse("!!{int}");
		@Test public void test_447() { testInvalid(test_447_sup,test_447_sub); }

		private static final SyntacticType test_448_sup = parse("{{{any}}}");
		private static final SyntacticType test_448_sub = parse("!!!any");
		@Test public void test_448() { testValid(test_448_sup,test_448_sub); }

		private static final SyntacticType test_449_sup = parse("{{{any}}}");
		private static final SyntacticType test_449_sub = parse("!!!int");
		@Test public void test_449() { testInvalid(test_449_sup,test_449_sub); }

		private static final SyntacticType test_450_sup = parse("{{{int}}}");
		private static final SyntacticType test_450_sub = parse("any");
		@Test public void test_450() { testInvalid(test_450_sup,test_450_sub); }

		private static final SyntacticType test_451_sup = parse("{{{int}}}");
		private static final SyntacticType test_451_sub = parse("int");
		@Test public void test_451() { testInvalid(test_451_sup,test_451_sub); }

		private static final SyntacticType test_452_sup = parse("{{{int}}}");
		private static final SyntacticType test_452_sub = parse("{any}");
		@Test public void test_452() { testInvalid(test_452_sup,test_452_sub); }

		private static final SyntacticType test_453_sup = parse("{{{int}}}");
		private static final SyntacticType test_453_sub = parse("{int}");
		@Test public void test_453() { testInvalid(test_453_sup,test_453_sub); }

		private static final SyntacticType test_454_sup = parse("{{{int}}}");
		private static final SyntacticType test_454_sub = parse("!any");
		@Test public void test_454() { testValid(test_454_sup,test_454_sub); }

		private static final SyntacticType test_455_sup = parse("{{{int}}}");
		private static final SyntacticType test_455_sub = parse("!int");
		@Test public void test_455() { testInvalid(test_455_sup,test_455_sub); }

		private static final SyntacticType test_456_sup = parse("{{{int}}}");
		private static final SyntacticType test_456_sub = parse("{{any}}");
		@Test public void test_456() { testInvalid(test_456_sup,test_456_sub); }

		private static final SyntacticType test_457_sup = parse("{{{int}}}");
		private static final SyntacticType test_457_sub = parse("{{int}}");
		@Test public void test_457() { testInvalid(test_457_sup,test_457_sub); }

		private static final SyntacticType test_458_sup = parse("{{{int}}}");
		private static final SyntacticType test_458_sub = parse("{!any}");
		@Test public void test_458() { testValid(test_458_sup,test_458_sub); }

		private static final SyntacticType test_459_sup = parse("{{{int}}}");
		private static final SyntacticType test_459_sub = parse("{!int}");
		@Test public void test_459() { testInvalid(test_459_sup,test_459_sub); }

		private static final SyntacticType test_460_sup = parse("{{{int}}}");
		private static final SyntacticType test_460_sub = parse("!{any}");
		@Test public void test_460() { testInvalid(test_460_sup,test_460_sub); }

		private static final SyntacticType test_461_sup = parse("{{{int}}}");
		private static final SyntacticType test_461_sub = parse("!{int}");
		@Test public void test_461() { testInvalid(test_461_sup,test_461_sub); }

		private static final SyntacticType test_462_sup = parse("{{{int}}}");
		private static final SyntacticType test_462_sub = parse("!!any");
		@Test public void test_462() { testInvalid(test_462_sup,test_462_sub); }

		private static final SyntacticType test_463_sup = parse("{{{int}}}");
		private static final SyntacticType test_463_sub = parse("!!int");
		@Test public void test_463() { testInvalid(test_463_sup,test_463_sub); }

		private static final SyntacticType test_464_sup = parse("{{{int}}}");
		private static final SyntacticType test_464_sub = parse("{{{any}}}");
		@Test public void test_464() { testInvalid(test_464_sup,test_464_sub); }

		private static final SyntacticType test_465_sup = parse("{{{int}}}");
		private static final SyntacticType test_465_sub = parse("{{{int}}}");
		@Test public void test_465() { testValid(test_465_sup,test_465_sub); }

		private static final SyntacticType test_466_sup = parse("{{{int}}}");
		private static final SyntacticType test_466_sub = parse("{{!any}}");
		@Test public void test_466() { testValid(test_466_sup,test_466_sub); }

		private static final SyntacticType test_467_sup = parse("{{{int}}}");
		private static final SyntacticType test_467_sub = parse("{{!int}}");
		@Test public void test_467() { testInvalid(test_467_sup,test_467_sub); }

		private static final SyntacticType test_468_sup = parse("{{{int}}}");
		private static final SyntacticType test_468_sub = parse("{!{any}}");
		@Test public void test_468() { testInvalid(test_468_sup,test_468_sub); }

		private static final SyntacticType test_469_sup = parse("{{{int}}}");
		private static final SyntacticType test_469_sub = parse("{!{int}}");
		@Test public void test_469() { testInvalid(test_469_sup,test_469_sub); }

		private static final SyntacticType test_470_sup = parse("{{{int}}}");
		private static final SyntacticType test_470_sub = parse("{!!any}");
		@Test public void test_470() { testInvalid(test_470_sup,test_470_sub); }

		private static final SyntacticType test_471_sup = parse("{{{int}}}");
		private static final SyntacticType test_471_sub = parse("{!!int}");
		@Test public void test_471() { testInvalid(test_471_sup,test_471_sub); }

		private static final SyntacticType test_472_sup = parse("{{{int}}}");
		private static final SyntacticType test_472_sub = parse("!{{any}}");
		@Test public void test_472() { testInvalid(test_472_sup,test_472_sub); }

		private static final SyntacticType test_473_sup = parse("{{{int}}}");
		private static final SyntacticType test_473_sub = parse("!{{int}}");
		@Test public void test_473() { testInvalid(test_473_sup,test_473_sub); }

		private static final SyntacticType test_474_sup = parse("{{{int}}}");
		private static final SyntacticType test_474_sub = parse("!{!any}");
		@Test public void test_474() { testInvalid(test_474_sup,test_474_sub); }

		private static final SyntacticType test_475_sup = parse("{{{int}}}");
		private static final SyntacticType test_475_sub = parse("!{!int}");
		@Test public void test_475() { testInvalid(test_475_sup,test_475_sub); }

		private static final SyntacticType test_476_sup = parse("{{{int}}}");
		private static final SyntacticType test_476_sub = parse("!!{any}");
		@Test public void test_476() { testInvalid(test_476_sup,test_476_sub); }

		private static final SyntacticType test_477_sup = parse("{{{int}}}");
		private static final SyntacticType test_477_sub = parse("!!{int}");
		@Test public void test_477() { testInvalid(test_477_sup,test_477_sub); }

		private static final SyntacticType test_478_sup = parse("{{{int}}}");
		private static final SyntacticType test_478_sub = parse("!!!any");
		@Test public void test_478() { testValid(test_478_sup,test_478_sub); }

		private static final SyntacticType test_479_sup = parse("{{{int}}}");
		private static final SyntacticType test_479_sub = parse("!!!int");
		@Test public void test_479() { testInvalid(test_479_sup,test_479_sub); }

		private static final SyntacticType test_480_sup = parse("{{!any}}");
		private static final SyntacticType test_480_sub = parse("any");
		@Test public void test_480() { testInvalid(test_480_sup,test_480_sub); }

		private static final SyntacticType test_481_sup = parse("{{!any}}");
		private static final SyntacticType test_481_sub = parse("int");
		@Test public void test_481() { testInvalid(test_481_sup,test_481_sub); }

		private static final SyntacticType test_482_sup = parse("{{!any}}");
		private static final SyntacticType test_482_sub = parse("{any}");
		@Test public void test_482() { testInvalid(test_482_sup,test_482_sub); }

		private static final SyntacticType test_483_sup = parse("{{!any}}");
		private static final SyntacticType test_483_sub = parse("{int}");
		@Test public void test_483() { testInvalid(test_483_sup,test_483_sub); }

		private static final SyntacticType test_484_sup = parse("{{!any}}");
		private static final SyntacticType test_484_sub = parse("!any");
		@Test public void test_484() { testValid(test_484_sup,test_484_sub); }

		private static final SyntacticType test_485_sup = parse("{{!any}}");
		private static final SyntacticType test_485_sub = parse("!int");
		@Test public void test_485() { testInvalid(test_485_sup,test_485_sub); }

		private static final SyntacticType test_486_sup = parse("{{!any}}");
		private static final SyntacticType test_486_sub = parse("{{any}}");
		@Test public void test_486() { testInvalid(test_486_sup,test_486_sub); }

		private static final SyntacticType test_487_sup = parse("{{!any}}");
		private static final SyntacticType test_487_sub = parse("{{int}}");
		@Test public void test_487() { testInvalid(test_487_sup,test_487_sub); }

		private static final SyntacticType test_488_sup = parse("{{!any}}");
		private static final SyntacticType test_488_sub = parse("{!any}");
		@Test public void test_488() { testValid(test_488_sup,test_488_sub); }

		private static final SyntacticType test_489_sup = parse("{{!any}}");
		private static final SyntacticType test_489_sub = parse("{!int}");
		@Test public void test_489() { testInvalid(test_489_sup,test_489_sub); }

		private static final SyntacticType test_490_sup = parse("{{!any}}");
		private static final SyntacticType test_490_sub = parse("!{any}");
		@Test public void test_490() { testInvalid(test_490_sup,test_490_sub); }

		private static final SyntacticType test_491_sup = parse("{{!any}}");
		private static final SyntacticType test_491_sub = parse("!{int}");
		@Test public void test_491() { testInvalid(test_491_sup,test_491_sub); }

		private static final SyntacticType test_492_sup = parse("{{!any}}");
		private static final SyntacticType test_492_sub = parse("!!any");
		@Test public void test_492() { testInvalid(test_492_sup,test_492_sub); }

		private static final SyntacticType test_493_sup = parse("{{!any}}");
		private static final SyntacticType test_493_sub = parse("!!int");
		@Test public void test_493() { testInvalid(test_493_sup,test_493_sub); }

		private static final SyntacticType test_494_sup = parse("{{!any}}");
		private static final SyntacticType test_494_sub = parse("{{{any}}}");
		@Test public void test_494() { testInvalid(test_494_sup,test_494_sub); }

		private static final SyntacticType test_495_sup = parse("{{!any}}");
		private static final SyntacticType test_495_sub = parse("{{{int}}}");
		@Test public void test_495() { testInvalid(test_495_sup,test_495_sub); }

		private static final SyntacticType test_496_sup = parse("{{!any}}");
		private static final SyntacticType test_496_sub = parse("{{!any}}");
		@Test public void test_496() { testValid(test_496_sup,test_496_sub); }

		private static final SyntacticType test_497_sup = parse("{{!any}}");
		private static final SyntacticType test_497_sub = parse("{{!int}}");
		@Test public void test_497() { testInvalid(test_497_sup,test_497_sub); }

		private static final SyntacticType test_498_sup = parse("{{!any}}");
		private static final SyntacticType test_498_sub = parse("{!{any}}");
		@Test public void test_498() { testInvalid(test_498_sup,test_498_sub); }

		private static final SyntacticType test_499_sup = parse("{{!any}}");
		private static final SyntacticType test_499_sub = parse("{!{int}}");
		@Test public void test_499() { testInvalid(test_499_sup,test_499_sub); }

		private static final SyntacticType test_500_sup = parse("{{!any}}");
		private static final SyntacticType test_500_sub = parse("{!!any}");
		@Test public void test_500() { testInvalid(test_500_sup,test_500_sub); }

		private static final SyntacticType test_501_sup = parse("{{!any}}");
		private static final SyntacticType test_501_sub = parse("{!!int}");
		@Test public void test_501() { testInvalid(test_501_sup,test_501_sub); }

		private static final SyntacticType test_502_sup = parse("{{!any}}");
		private static final SyntacticType test_502_sub = parse("!{{any}}");
		@Test public void test_502() { testInvalid(test_502_sup,test_502_sub); }

		private static final SyntacticType test_503_sup = parse("{{!any}}");
		private static final SyntacticType test_503_sub = parse("!{{int}}");
		@Test public void test_503() { testInvalid(test_503_sup,test_503_sub); }

		private static final SyntacticType test_504_sup = parse("{{!any}}");
		private static final SyntacticType test_504_sub = parse("!{!any}");
		@Test public void test_504() { testInvalid(test_504_sup,test_504_sub); }

		private static final SyntacticType test_505_sup = parse("{{!any}}");
		private static final SyntacticType test_505_sub = parse("!{!int}");
		@Test public void test_505() { testInvalid(test_505_sup,test_505_sub); }

		private static final SyntacticType test_506_sup = parse("{{!any}}");
		private static final SyntacticType test_506_sub = parse("!!{any}");
		@Test public void test_506() { testInvalid(test_506_sup,test_506_sub); }

		private static final SyntacticType test_507_sup = parse("{{!any}}");
		private static final SyntacticType test_507_sub = parse("!!{int}");
		@Test public void test_507() { testInvalid(test_507_sup,test_507_sub); }

		private static final SyntacticType test_508_sup = parse("{{!any}}");
		private static final SyntacticType test_508_sub = parse("!!!any");
		@Test public void test_508() { testValid(test_508_sup,test_508_sub); }

		private static final SyntacticType test_509_sup = parse("{{!any}}");
		private static final SyntacticType test_509_sub = parse("!!!int");
		@Test public void test_509() { testInvalid(test_509_sup,test_509_sub); }

		private static final SyntacticType test_510_sup = parse("{{!int}}");
		private static final SyntacticType test_510_sub = parse("any");
		@Test public void test_510() { testInvalid(test_510_sup,test_510_sub); }

		private static final SyntacticType test_511_sup = parse("{{!int}}");
		private static final SyntacticType test_511_sub = parse("int");
		@Test public void test_511() { testInvalid(test_511_sup,test_511_sub); }

		private static final SyntacticType test_512_sup = parse("{{!int}}");
		private static final SyntacticType test_512_sub = parse("{any}");
		@Test public void test_512() { testInvalid(test_512_sup,test_512_sub); }

		private static final SyntacticType test_513_sup = parse("{{!int}}");
		private static final SyntacticType test_513_sub = parse("{int}");
		@Test public void test_513() { testInvalid(test_513_sup,test_513_sub); }

		private static final SyntacticType test_514_sup = parse("{{!int}}");
		private static final SyntacticType test_514_sub = parse("!any");
		@Test public void test_514() { testValid(test_514_sup,test_514_sub); }

		private static final SyntacticType test_515_sup = parse("{{!int}}");
		private static final SyntacticType test_515_sub = parse("!int");
		@Test public void test_515() { testInvalid(test_515_sup,test_515_sub); }

		private static final SyntacticType test_516_sup = parse("{{!int}}");
		private static final SyntacticType test_516_sub = parse("{{any}}");
		@Test public void test_516() { testInvalid(test_516_sup,test_516_sub); }

		private static final SyntacticType test_517_sup = parse("{{!int}}");
		private static final SyntacticType test_517_sub = parse("{{int}}");
		@Test public void test_517() { testInvalid(test_517_sup,test_517_sub); }

		private static final SyntacticType test_518_sup = parse("{{!int}}");
		private static final SyntacticType test_518_sub = parse("{!any}");
		@Test public void test_518() { testValid(test_518_sup,test_518_sub); }

		private static final SyntacticType test_519_sup = parse("{{!int}}");
		private static final SyntacticType test_519_sub = parse("{!int}");
		@Test public void test_519() { testInvalid(test_519_sup,test_519_sub); }

		private static final SyntacticType test_520_sup = parse("{{!int}}");
		private static final SyntacticType test_520_sub = parse("!{any}");
		@Test public void test_520() { testInvalid(test_520_sup,test_520_sub); }

		private static final SyntacticType test_521_sup = parse("{{!int}}");
		private static final SyntacticType test_521_sub = parse("!{int}");
		@Test public void test_521() { testInvalid(test_521_sup,test_521_sub); }

		private static final SyntacticType test_522_sup = parse("{{!int}}");
		private static final SyntacticType test_522_sub = parse("!!any");
		@Test public void test_522() { testInvalid(test_522_sup,test_522_sub); }

		private static final SyntacticType test_523_sup = parse("{{!int}}");
		private static final SyntacticType test_523_sub = parse("!!int");
		@Test public void test_523() { testInvalid(test_523_sup,test_523_sub); }

		private static final SyntacticType test_524_sup = parse("{{!int}}");
		private static final SyntacticType test_524_sub = parse("{{{any}}}");
		@Test public void test_524() { testValid(test_524_sup,test_524_sub); }

		private static final SyntacticType test_525_sup = parse("{{!int}}");
		private static final SyntacticType test_525_sub = parse("{{{int}}}");
		@Test public void test_525() { testValid(test_525_sup,test_525_sub); }

		private static final SyntacticType test_526_sup = parse("{{!int}}");
		private static final SyntacticType test_526_sub = parse("{{!any}}");
		@Test public void test_526() { testValid(test_526_sup,test_526_sub); }

		private static final SyntacticType test_527_sup = parse("{{!int}}");
		private static final SyntacticType test_527_sub = parse("{{!int}}");
		@Test public void test_527() { testValid(test_527_sup,test_527_sub); }

		private static final SyntacticType test_528_sup = parse("{{!int}}");
		private static final SyntacticType test_528_sub = parse("{!{any}}");
		@Test public void test_528() { testInvalid(test_528_sup,test_528_sub); }

		private static final SyntacticType test_529_sup = parse("{{!int}}");
		private static final SyntacticType test_529_sub = parse("{!{int}}");
		@Test public void test_529() { testInvalid(test_529_sup,test_529_sub); }

		private static final SyntacticType test_530_sup = parse("{{!int}}");
		private static final SyntacticType test_530_sub = parse("{!!any}");
		@Test public void test_530() { testInvalid(test_530_sup,test_530_sub); }

		private static final SyntacticType test_531_sup = parse("{{!int}}");
		private static final SyntacticType test_531_sub = parse("{!!int}");
		@Test public void test_531() { testInvalid(test_531_sup,test_531_sub); }

		private static final SyntacticType test_532_sup = parse("{{!int}}");
		private static final SyntacticType test_532_sub = parse("!{{any}}");
		@Test public void test_532() { testInvalid(test_532_sup,test_532_sub); }

		private static final SyntacticType test_533_sup = parse("{{!int}}");
		private static final SyntacticType test_533_sub = parse("!{{int}}");
		@Test public void test_533() { testInvalid(test_533_sup,test_533_sub); }

		private static final SyntacticType test_534_sup = parse("{{!int}}");
		private static final SyntacticType test_534_sub = parse("!{!any}");
		@Test public void test_534() { testInvalid(test_534_sup,test_534_sub); }

		private static final SyntacticType test_535_sup = parse("{{!int}}");
		private static final SyntacticType test_535_sub = parse("!{!int}");
		@Test public void test_535() { testInvalid(test_535_sup,test_535_sub); }

		private static final SyntacticType test_536_sup = parse("{{!int}}");
		private static final SyntacticType test_536_sub = parse("!!{any}");
		@Test public void test_536() { testInvalid(test_536_sup,test_536_sub); }

		private static final SyntacticType test_537_sup = parse("{{!int}}");
		private static final SyntacticType test_537_sub = parse("!!{int}");
		@Test public void test_537() { testInvalid(test_537_sup,test_537_sub); }

		private static final SyntacticType test_538_sup = parse("{{!int}}");
		private static final SyntacticType test_538_sub = parse("!!!any");
		@Test public void test_538() { testValid(test_538_sup,test_538_sub); }

		private static final SyntacticType test_539_sup = parse("{{!int}}");
		private static final SyntacticType test_539_sub = parse("!!!int");
		@Test public void test_539() { testInvalid(test_539_sup,test_539_sub); }

		private static final SyntacticType test_540_sup = parse("{!{any}}");
		private static final SyntacticType test_540_sub = parse("any");
		@Test public void test_540() { testInvalid(test_540_sup,test_540_sub); }

		private static final SyntacticType test_541_sup = parse("{!{any}}");
		private static final SyntacticType test_541_sub = parse("int");
		@Test public void test_541() { testInvalid(test_541_sup,test_541_sub); }

		private static final SyntacticType test_542_sup = parse("{!{any}}");
		private static final SyntacticType test_542_sub = parse("{any}");
		@Test public void test_542() { testInvalid(test_542_sup,test_542_sub); }

		private static final SyntacticType test_543_sup = parse("{!{any}}");
		private static final SyntacticType test_543_sub = parse("{int}");
		@Test public void test_543() { testValid(test_543_sup,test_543_sub); }

		private static final SyntacticType test_544_sup = parse("{!{any}}");
		private static final SyntacticType test_544_sub = parse("!any");
		@Test public void test_544() { testValid(test_544_sup,test_544_sub); }

		private static final SyntacticType test_545_sup = parse("{!{any}}");
		private static final SyntacticType test_545_sub = parse("!int");
		@Test public void test_545() { testInvalid(test_545_sup,test_545_sub); }

		private static final SyntacticType test_546_sup = parse("{!{any}}");
		private static final SyntacticType test_546_sub = parse("{{any}}");
		@Test public void test_546() { testInvalid(test_546_sup,test_546_sub); }

		private static final SyntacticType test_547_sup = parse("{!{any}}");
		private static final SyntacticType test_547_sub = parse("{{int}}");
		@Test public void test_547() { testInvalid(test_547_sup,test_547_sub); }

		private static final SyntacticType test_548_sup = parse("{!{any}}");
		private static final SyntacticType test_548_sub = parse("{!any}");
		@Test public void test_548() { testValid(test_548_sup,test_548_sub); }

		private static final SyntacticType test_549_sup = parse("{!{any}}");
		private static final SyntacticType test_549_sub = parse("{!int}");
		@Test public void test_549() { testInvalid(test_549_sup,test_549_sub); }

		private static final SyntacticType test_550_sup = parse("{!{any}}");
		private static final SyntacticType test_550_sub = parse("!{any}");
		@Test public void test_550() { testInvalid(test_550_sup,test_550_sub); }

		private static final SyntacticType test_551_sup = parse("{!{any}}");
		private static final SyntacticType test_551_sub = parse("!{int}");
		@Test public void test_551() { testInvalid(test_551_sup,test_551_sub); }

		private static final SyntacticType test_552_sup = parse("{!{any}}");
		private static final SyntacticType test_552_sub = parse("!!any");
		@Test public void test_552() { testInvalid(test_552_sup,test_552_sub); }

		private static final SyntacticType test_553_sup = parse("{!{any}}");
		private static final SyntacticType test_553_sub = parse("!!int");
		@Test public void test_553() { testInvalid(test_553_sup,test_553_sub); }

		private static final SyntacticType test_554_sup = parse("{!{any}}");
		private static final SyntacticType test_554_sub = parse("{{{any}}}");
		@Test public void test_554() { testInvalid(test_554_sup,test_554_sub); }

		private static final SyntacticType test_555_sup = parse("{!{any}}");
		private static final SyntacticType test_555_sub = parse("{{{int}}}");
		@Test public void test_555() { testInvalid(test_555_sup,test_555_sub); }

		private static final SyntacticType test_556_sup = parse("{!{any}}");
		private static final SyntacticType test_556_sub = parse("{{!any}}");
		@Test public void test_556() { testValid(test_556_sup,test_556_sub); }

		private static final SyntacticType test_557_sup = parse("{!{any}}");
		private static final SyntacticType test_557_sub = parse("{{!int}}");
		@Test public void test_557() { testInvalid(test_557_sup,test_557_sub); }

		private static final SyntacticType test_558_sup = parse("{!{any}}");
		private static final SyntacticType test_558_sub = parse("{!{any}}");
		@Test public void test_558() { testValid(test_558_sup,test_558_sub); }

		private static final SyntacticType test_559_sup = parse("{!{any}}");
		private static final SyntacticType test_559_sub = parse("{!{int}}");
		@Test public void test_559() { testInvalid(test_559_sup,test_559_sub); }

		private static final SyntacticType test_560_sup = parse("{!{any}}");
		private static final SyntacticType test_560_sub = parse("{!!any}");
		@Test public void test_560() { testInvalid(test_560_sup,test_560_sub); }

		private static final SyntacticType test_561_sup = parse("{!{any}}");
		private static final SyntacticType test_561_sub = parse("{!!int}");
		@Test public void test_561() { testValid(test_561_sup,test_561_sub); }

		private static final SyntacticType test_562_sup = parse("{!{any}}");
		private static final SyntacticType test_562_sub = parse("!{{any}}");
		@Test public void test_562() { testInvalid(test_562_sup,test_562_sub); }

		private static final SyntacticType test_563_sup = parse("{!{any}}");
		private static final SyntacticType test_563_sub = parse("!{{int}}");
		@Test public void test_563() { testInvalid(test_563_sup,test_563_sub); }

		private static final SyntacticType test_564_sup = parse("{!{any}}");
		private static final SyntacticType test_564_sub = parse("!{!any}");
		@Test public void test_564() { testInvalid(test_564_sup,test_564_sub); }

		private static final SyntacticType test_565_sup = parse("{!{any}}");
		private static final SyntacticType test_565_sub = parse("!{!int}");
		@Test public void test_565() { testInvalid(test_565_sup,test_565_sub); }

		private static final SyntacticType test_566_sup = parse("{!{any}}");
		private static final SyntacticType test_566_sub = parse("!!{any}");
		@Test public void test_566() { testInvalid(test_566_sup,test_566_sub); }

		private static final SyntacticType test_567_sup = parse("{!{any}}");
		private static final SyntacticType test_567_sub = parse("!!{int}");
		@Test public void test_567() { testValid(test_567_sup,test_567_sub); }

		private static final SyntacticType test_568_sup = parse("{!{any}}");
		private static final SyntacticType test_568_sub = parse("!!!any");
		@Test public void test_568() { testValid(test_568_sup,test_568_sub); }

		private static final SyntacticType test_569_sup = parse("{!{any}}");
		private static final SyntacticType test_569_sub = parse("!!!int");
		@Test public void test_569() { testInvalid(test_569_sup,test_569_sub); }

		private static final SyntacticType test_570_sup = parse("{!{int}}");
		private static final SyntacticType test_570_sub = parse("any");
		@Test public void test_570() { testInvalid(test_570_sup,test_570_sub); }

		private static final SyntacticType test_571_sup = parse("{!{int}}");
		private static final SyntacticType test_571_sub = parse("int");
		@Test public void test_571() { testInvalid(test_571_sup,test_571_sub); }

		private static final SyntacticType test_572_sup = parse("{!{int}}");
		private static final SyntacticType test_572_sub = parse("{any}");
		@Test public void test_572() { testInvalid(test_572_sup,test_572_sub); }

		private static final SyntacticType test_573_sup = parse("{!{int}}");
		private static final SyntacticType test_573_sub = parse("{int}");
		@Test public void test_573() { testValid(test_573_sup,test_573_sub); }

		private static final SyntacticType test_574_sup = parse("{!{int}}");
		private static final SyntacticType test_574_sub = parse("!any");
		@Test public void test_574() { testValid(test_574_sup,test_574_sub); }

		private static final SyntacticType test_575_sup = parse("{!{int}}");
		private static final SyntacticType test_575_sub = parse("!int");
		@Test public void test_575() { testInvalid(test_575_sup,test_575_sub); }

		private static final SyntacticType test_576_sup = parse("{!{int}}");
		private static final SyntacticType test_576_sub = parse("{{any}}");
		@Test public void test_576() { testInvalid(test_576_sup,test_576_sub); }

		private static final SyntacticType test_577_sup = parse("{!{int}}");
		private static final SyntacticType test_577_sub = parse("{{int}}");
		@Test public void test_577() { testInvalid(test_577_sup,test_577_sub); }

		private static final SyntacticType test_578_sup = parse("{!{int}}");
		private static final SyntacticType test_578_sub = parse("{!any}");
		@Test public void test_578() { testValid(test_578_sup,test_578_sub); }

		private static final SyntacticType test_579_sup = parse("{!{int}}");
		private static final SyntacticType test_579_sub = parse("{!int}");
		@Test public void test_579() { testInvalid(test_579_sup,test_579_sub); }

		private static final SyntacticType test_580_sup = parse("{!{int}}");
		private static final SyntacticType test_580_sub = parse("!{any}");
		@Test public void test_580() { testInvalid(test_580_sup,test_580_sub); }

		private static final SyntacticType test_581_sup = parse("{!{int}}");
		private static final SyntacticType test_581_sub = parse("!{int}");
		@Test public void test_581() { testInvalid(test_581_sup,test_581_sub); }

		private static final SyntacticType test_582_sup = parse("{!{int}}");
		private static final SyntacticType test_582_sub = parse("!!any");
		@Test public void test_582() { testInvalid(test_582_sup,test_582_sub); }

		private static final SyntacticType test_583_sup = parse("{!{int}}");
		private static final SyntacticType test_583_sub = parse("!!int");
		@Test public void test_583() { testInvalid(test_583_sup,test_583_sub); }

		private static final SyntacticType test_584_sup = parse("{!{int}}");
		private static final SyntacticType test_584_sub = parse("{{{any}}}");
		@Test public void test_584() { testValid(test_584_sup,test_584_sub); }

		private static final SyntacticType test_585_sup = parse("{!{int}}");
		private static final SyntacticType test_585_sub = parse("{{{int}}}");
		@Test public void test_585() { testValid(test_585_sup,test_585_sub); }

		private static final SyntacticType test_586_sup = parse("{!{int}}");
		private static final SyntacticType test_586_sub = parse("{{!any}}");
		@Test public void test_586() { testValid(test_586_sup,test_586_sub); }

		private static final SyntacticType test_587_sup = parse("{!{int}}");
		private static final SyntacticType test_587_sub = parse("{{!int}}");
		@Test public void test_587() { testValid(test_587_sup,test_587_sub); }

		private static final SyntacticType test_588_sup = parse("{!{int}}");
		private static final SyntacticType test_588_sub = parse("{!{any}}");
		@Test public void test_588() { testValid(test_588_sup,test_588_sub); }

		private static final SyntacticType test_589_sup = parse("{!{int}}");
		private static final SyntacticType test_589_sub = parse("{!{int}}");
		@Test public void test_589() { testValid(test_589_sup,test_589_sub); }

		private static final SyntacticType test_590_sup = parse("{!{int}}");
		private static final SyntacticType test_590_sub = parse("{!!any}");
		@Test public void test_590() { testInvalid(test_590_sup,test_590_sub); }

		private static final SyntacticType test_591_sup = parse("{!{int}}");
		private static final SyntacticType test_591_sub = parse("{!!int}");
		@Test public void test_591() { testValid(test_591_sup,test_591_sub); }

		private static final SyntacticType test_592_sup = parse("{!{int}}");
		private static final SyntacticType test_592_sub = parse("!{{any}}");
		@Test public void test_592() { testInvalid(test_592_sup,test_592_sub); }

		private static final SyntacticType test_593_sup = parse("{!{int}}");
		private static final SyntacticType test_593_sub = parse("!{{int}}");
		@Test public void test_593() { testInvalid(test_593_sup,test_593_sub); }

		private static final SyntacticType test_594_sup = parse("{!{int}}");
		private static final SyntacticType test_594_sub = parse("!{!any}");
		@Test public void test_594() { testInvalid(test_594_sup,test_594_sub); }

		private static final SyntacticType test_595_sup = parse("{!{int}}");
		private static final SyntacticType test_595_sub = parse("!{!int}");
		@Test public void test_595() { testInvalid(test_595_sup,test_595_sub); }

		private static final SyntacticType test_596_sup = parse("{!{int}}");
		private static final SyntacticType test_596_sub = parse("!!{any}");
		@Test public void test_596() { testInvalid(test_596_sup,test_596_sub); }

		private static final SyntacticType test_597_sup = parse("{!{int}}");
		private static final SyntacticType test_597_sub = parse("!!{int}");
		@Test public void test_597() { testValid(test_597_sup,test_597_sub); }

		private static final SyntacticType test_598_sup = parse("{!{int}}");
		private static final SyntacticType test_598_sub = parse("!!!any");
		@Test public void test_598() { testValid(test_598_sup,test_598_sub); }

		private static final SyntacticType test_599_sup = parse("{!{int}}");
		private static final SyntacticType test_599_sub = parse("!!!int");
		@Test public void test_599() { testInvalid(test_599_sup,test_599_sub); }

		private static final SyntacticType test_600_sup = parse("{!!any}");
		private static final SyntacticType test_600_sub = parse("any");
		@Test public void test_600() { testInvalid(test_600_sup,test_600_sub); }

		private static final SyntacticType test_601_sup = parse("{!!any}");
		private static final SyntacticType test_601_sub = parse("int");
		@Test public void test_601() { testInvalid(test_601_sup,test_601_sub); }

		private static final SyntacticType test_602_sup = parse("{!!any}");
		private static final SyntacticType test_602_sub = parse("{any}");
		@Test public void test_602() { testValid(test_602_sup,test_602_sub); }

		private static final SyntacticType test_603_sup = parse("{!!any}");
		private static final SyntacticType test_603_sub = parse("{int}");
		@Test public void test_603() { testValid(test_603_sup,test_603_sub); }

		private static final SyntacticType test_604_sup = parse("{!!any}");
		private static final SyntacticType test_604_sub = parse("!any");
		@Test public void test_604() { testValid(test_604_sup,test_604_sub); }

		private static final SyntacticType test_605_sup = parse("{!!any}");
		private static final SyntacticType test_605_sub = parse("!int");
		@Test public void test_605() { testInvalid(test_605_sup,test_605_sub); }

		private static final SyntacticType test_606_sup = parse("{!!any}");
		private static final SyntacticType test_606_sub = parse("{{any}}");
		@Test public void test_606() { testValid(test_606_sup,test_606_sub); }

		private static final SyntacticType test_607_sup = parse("{!!any}");
		private static final SyntacticType test_607_sub = parse("{{int}}");
		@Test public void test_607() { testValid(test_607_sup,test_607_sub); }

		private static final SyntacticType test_608_sup = parse("{!!any}");
		private static final SyntacticType test_608_sub = parse("{!any}");
		@Test public void test_608() { testValid(test_608_sup,test_608_sub); }

		private static final SyntacticType test_609_sup = parse("{!!any}");
		private static final SyntacticType test_609_sub = parse("{!int}");
		@Test public void test_609() { testValid(test_609_sup,test_609_sub); }

		private static final SyntacticType test_610_sup = parse("{!!any}");
		private static final SyntacticType test_610_sub = parse("!{any}");
		@Test public void test_610() { testInvalid(test_610_sup,test_610_sub); }

		private static final SyntacticType test_611_sup = parse("{!!any}");
		private static final SyntacticType test_611_sub = parse("!{int}");
		@Test public void test_611() { testInvalid(test_611_sup,test_611_sub); }

		private static final SyntacticType test_612_sup = parse("{!!any}");
		private static final SyntacticType test_612_sub = parse("!!any");
		@Test public void test_612() { testInvalid(test_612_sup,test_612_sub); }

		private static final SyntacticType test_613_sup = parse("{!!any}");
		private static final SyntacticType test_613_sub = parse("!!int");
		@Test public void test_613() { testInvalid(test_613_sup,test_613_sub); }

		private static final SyntacticType test_614_sup = parse("{!!any}");
		private static final SyntacticType test_614_sub = parse("{{{any}}}");
		@Test public void test_614() { testValid(test_614_sup,test_614_sub); }

		private static final SyntacticType test_615_sup = parse("{!!any}");
		private static final SyntacticType test_615_sub = parse("{{{int}}}");
		@Test public void test_615() { testValid(test_615_sup,test_615_sub); }

		private static final SyntacticType test_616_sup = parse("{!!any}");
		private static final SyntacticType test_616_sub = parse("{{!any}}");
		@Test public void test_616() { testValid(test_616_sup,test_616_sub); }

		private static final SyntacticType test_617_sup = parse("{!!any}");
		private static final SyntacticType test_617_sub = parse("{{!int}}");
		@Test public void test_617() { testValid(test_617_sup,test_617_sub); }

		private static final SyntacticType test_618_sup = parse("{!!any}");
		private static final SyntacticType test_618_sub = parse("{!{any}}");
		@Test public void test_618() { testValid(test_618_sup,test_618_sub); }

		private static final SyntacticType test_619_sup = parse("{!!any}");
		private static final SyntacticType test_619_sub = parse("{!{int}}");
		@Test public void test_619() { testValid(test_619_sup,test_619_sub); }

		private static final SyntacticType test_620_sup = parse("{!!any}");
		private static final SyntacticType test_620_sub = parse("{!!any}");
		@Test public void test_620() { testValid(test_620_sup,test_620_sub); }

		private static final SyntacticType test_621_sup = parse("{!!any}");
		private static final SyntacticType test_621_sub = parse("{!!int}");
		@Test public void test_621() { testValid(test_621_sup,test_621_sub); }

		private static final SyntacticType test_622_sup = parse("{!!any}");
		private static final SyntacticType test_622_sub = parse("!{{any}}");
		@Test public void test_622() { testInvalid(test_622_sup,test_622_sub); }

		private static final SyntacticType test_623_sup = parse("{!!any}");
		private static final SyntacticType test_623_sub = parse("!{{int}}");
		@Test public void test_623() { testInvalid(test_623_sup,test_623_sub); }

		private static final SyntacticType test_624_sup = parse("{!!any}");
		private static final SyntacticType test_624_sub = parse("!{!any}");
		@Test public void test_624() { testInvalid(test_624_sup,test_624_sub); }

		private static final SyntacticType test_625_sup = parse("{!!any}");
		private static final SyntacticType test_625_sub = parse("!{!int}");
		@Test public void test_625() { testInvalid(test_625_sup,test_625_sub); }

		private static final SyntacticType test_626_sup = parse("{!!any}");
		private static final SyntacticType test_626_sub = parse("!!{any}");
		@Test public void test_626() { testValid(test_626_sup,test_626_sub); }

		private static final SyntacticType test_627_sup = parse("{!!any}");
		private static final SyntacticType test_627_sub = parse("!!{int}");
		@Test public void test_627() { testValid(test_627_sup,test_627_sub); }

		private static final SyntacticType test_628_sup = parse("{!!any}");
		private static final SyntacticType test_628_sub = parse("!!!any");
		@Test public void test_628() { testValid(test_628_sup,test_628_sub); }

		private static final SyntacticType test_629_sup = parse("{!!any}");
		private static final SyntacticType test_629_sub = parse("!!!int");
		@Test public void test_629() { testInvalid(test_629_sup,test_629_sub); }

		private static final SyntacticType test_630_sup = parse("{!!int}");
		private static final SyntacticType test_630_sub = parse("any");
		@Test public void test_630() { testInvalid(test_630_sup,test_630_sub); }

		private static final SyntacticType test_631_sup = parse("{!!int}");
		private static final SyntacticType test_631_sub = parse("int");
		@Test public void test_631() { testInvalid(test_631_sup,test_631_sub); }

		private static final SyntacticType test_632_sup = parse("{!!int}");
		private static final SyntacticType test_632_sub = parse("{any}");
		@Test public void test_632() { testInvalid(test_632_sup,test_632_sub); }

		private static final SyntacticType test_633_sup = parse("{!!int}");
		private static final SyntacticType test_633_sub = parse("{int}");
		@Test public void test_633() { testValid(test_633_sup,test_633_sub); }

		private static final SyntacticType test_634_sup = parse("{!!int}");
		private static final SyntacticType test_634_sub = parse("!any");
		@Test public void test_634() { testValid(test_634_sup,test_634_sub); }

		private static final SyntacticType test_635_sup = parse("{!!int}");
		private static final SyntacticType test_635_sub = parse("!int");
		@Test public void test_635() { testInvalid(test_635_sup,test_635_sub); }

		private static final SyntacticType test_636_sup = parse("{!!int}");
		private static final SyntacticType test_636_sub = parse("{{any}}");
		@Test public void test_636() { testInvalid(test_636_sup,test_636_sub); }

		private static final SyntacticType test_637_sup = parse("{!!int}");
		private static final SyntacticType test_637_sub = parse("{{int}}");
		@Test public void test_637() { testInvalid(test_637_sup,test_637_sub); }

		private static final SyntacticType test_638_sup = parse("{!!int}");
		private static final SyntacticType test_638_sub = parse("{!any}");
		@Test public void test_638() { testValid(test_638_sup,test_638_sub); }

		private static final SyntacticType test_639_sup = parse("{!!int}");
		private static final SyntacticType test_639_sub = parse("{!int}");
		@Test public void test_639() { testInvalid(test_639_sup,test_639_sub); }

		private static final SyntacticType test_640_sup = parse("{!!int}");
		private static final SyntacticType test_640_sub = parse("!{any}");
		@Test public void test_640() { testInvalid(test_640_sup,test_640_sub); }

		private static final SyntacticType test_641_sup = parse("{!!int}");
		private static final SyntacticType test_641_sub = parse("!{int}");
		@Test public void test_641() { testInvalid(test_641_sup,test_641_sub); }

		private static final SyntacticType test_642_sup = parse("{!!int}");
		private static final SyntacticType test_642_sub = parse("!!any");
		@Test public void test_642() { testInvalid(test_642_sup,test_642_sub); }

		private static final SyntacticType test_643_sup = parse("{!!int}");
		private static final SyntacticType test_643_sub = parse("!!int");
		@Test public void test_643() { testInvalid(test_643_sup,test_643_sub); }

		private static final SyntacticType test_644_sup = parse("{!!int}");
		private static final SyntacticType test_644_sub = parse("{{{any}}}");
		@Test public void test_644() { testInvalid(test_644_sup,test_644_sub); }

		private static final SyntacticType test_645_sup = parse("{!!int}");
		private static final SyntacticType test_645_sub = parse("{{{int}}}");
		@Test public void test_645() { testInvalid(test_645_sup,test_645_sub); }

		private static final SyntacticType test_646_sup = parse("{!!int}");
		private static final SyntacticType test_646_sub = parse("{{!any}}");
		@Test public void test_646() { testValid(test_646_sup,test_646_sub); }

		private static final SyntacticType test_647_sup = parse("{!!int}");
		private static final SyntacticType test_647_sub = parse("{{!int}}");
		@Test public void test_647() { testInvalid(test_647_sup,test_647_sub); }

		private static final SyntacticType test_648_sup = parse("{!!int}");
		private static final SyntacticType test_648_sub = parse("{!{any}}");
		@Test public void test_648() { testInvalid(test_648_sup,test_648_sub); }

		private static final SyntacticType test_649_sup = parse("{!!int}");
		private static final SyntacticType test_649_sub = parse("{!{int}}");
		@Test public void test_649() { testInvalid(test_649_sup,test_649_sub); }

		private static final SyntacticType test_650_sup = parse("{!!int}");
		private static final SyntacticType test_650_sub = parse("{!!any}");
		@Test public void test_650() { testInvalid(test_650_sup,test_650_sub); }

		private static final SyntacticType test_651_sup = parse("{!!int}");
		private static final SyntacticType test_651_sub = parse("{!!int}");
		@Test public void test_651() { testValid(test_651_sup,test_651_sub); }

		private static final SyntacticType test_652_sup = parse("{!!int}");
		private static final SyntacticType test_652_sub = parse("!{{any}}");
		@Test public void test_652() { testInvalid(test_652_sup,test_652_sub); }

		private static final SyntacticType test_653_sup = parse("{!!int}");
		private static final SyntacticType test_653_sub = parse("!{{int}}");
		@Test public void test_653() { testInvalid(test_653_sup,test_653_sub); }

		private static final SyntacticType test_654_sup = parse("{!!int}");
		private static final SyntacticType test_654_sub = parse("!{!any}");
		@Test public void test_654() { testInvalid(test_654_sup,test_654_sub); }

		private static final SyntacticType test_655_sup = parse("{!!int}");
		private static final SyntacticType test_655_sub = parse("!{!int}");
		@Test public void test_655() { testInvalid(test_655_sup,test_655_sub); }

		private static final SyntacticType test_656_sup = parse("{!!int}");
		private static final SyntacticType test_656_sub = parse("!!{any}");
		@Test public void test_656() { testInvalid(test_656_sup,test_656_sub); }

		private static final SyntacticType test_657_sup = parse("{!!int}");
		private static final SyntacticType test_657_sub = parse("!!{int}");
		@Test public void test_657() { testValid(test_657_sup,test_657_sub); }

		private static final SyntacticType test_658_sup = parse("{!!int}");
		private static final SyntacticType test_658_sub = parse("!!!any");
		@Test public void test_658() { testValid(test_658_sup,test_658_sub); }

		private static final SyntacticType test_659_sup = parse("{!!int}");
		private static final SyntacticType test_659_sub = parse("!!!int");
		@Test public void test_659() { testInvalid(test_659_sup,test_659_sub); }

		private static final SyntacticType test_660_sup = parse("!{{any}}");
		private static final SyntacticType test_660_sub = parse("any");
		@Test public void test_660() { testInvalid(test_660_sup,test_660_sub); }

		private static final SyntacticType test_661_sup = parse("!{{any}}");
		private static final SyntacticType test_661_sub = parse("int");
		@Test public void test_661() { testValid(test_661_sup,test_661_sub); }

		private static final SyntacticType test_662_sup = parse("!{{any}}");
		private static final SyntacticType test_662_sub = parse("{any}");
		@Test public void test_662() { testInvalid(test_662_sup,test_662_sub); }

		private static final SyntacticType test_663_sup = parse("!{{any}}");
		private static final SyntacticType test_663_sub = parse("{int}");
		@Test public void test_663() { testValid(test_663_sup,test_663_sub); }

		private static final SyntacticType test_664_sup = parse("!{{any}}");
		private static final SyntacticType test_664_sub = parse("!any");
		@Test public void test_664() { testValid(test_664_sup,test_664_sub); }

		private static final SyntacticType test_665_sup = parse("!{{any}}");
		private static final SyntacticType test_665_sub = parse("!int");
		@Test public void test_665() { testInvalid(test_665_sup,test_665_sub); }

		private static final SyntacticType test_666_sup = parse("!{{any}}");
		private static final SyntacticType test_666_sub = parse("{{any}}");
		@Test public void test_666() { testInvalid(test_666_sup,test_666_sub); }

		private static final SyntacticType test_667_sup = parse("!{{any}}");
		private static final SyntacticType test_667_sub = parse("{{int}}");
		@Test public void test_667() { testInvalid(test_667_sup,test_667_sub); }

		private static final SyntacticType test_668_sup = parse("!{{any}}");
		private static final SyntacticType test_668_sub = parse("{!any}");
		@Test public void test_668() { testValid(test_668_sup,test_668_sub); }

		private static final SyntacticType test_669_sup = parse("!{{any}}");
		private static final SyntacticType test_669_sub = parse("{!int}");
		@Test public void test_669() { testInvalid(test_669_sup,test_669_sub); }

		private static final SyntacticType test_670_sup = parse("!{{any}}");
		private static final SyntacticType test_670_sub = parse("!{any}");
		@Test public void test_670() { testValid(test_670_sup,test_670_sub); }

		private static final SyntacticType test_671_sup = parse("!{{any}}");
		private static final SyntacticType test_671_sub = parse("!{int}");
		@Test public void test_671() { testInvalid(test_671_sup,test_671_sub); }

		private static final SyntacticType test_672_sup = parse("!{{any}}");
		private static final SyntacticType test_672_sub = parse("!!any");
		@Test public void test_672() { testInvalid(test_672_sup,test_672_sub); }

		private static final SyntacticType test_673_sup = parse("!{{any}}");
		private static final SyntacticType test_673_sub = parse("!!int");
		@Test public void test_673() { testValid(test_673_sup,test_673_sub); }

		private static final SyntacticType test_674_sup = parse("!{{any}}");
		private static final SyntacticType test_674_sub = parse("{{{any}}}");
		@Test public void test_674() { testInvalid(test_674_sup,test_674_sub); }

		private static final SyntacticType test_675_sup = parse("!{{any}}");
		private static final SyntacticType test_675_sub = parse("{{{int}}}");
		@Test public void test_675() { testInvalid(test_675_sup,test_675_sub); }

		private static final SyntacticType test_676_sup = parse("!{{any}}");
		private static final SyntacticType test_676_sub = parse("{{!any}}");
		@Test public void test_676() { testValid(test_676_sup,test_676_sub); }

		private static final SyntacticType test_677_sup = parse("!{{any}}");
		private static final SyntacticType test_677_sub = parse("{{!int}}");
		@Test public void test_677() { testInvalid(test_677_sup,test_677_sub); }

		private static final SyntacticType test_678_sup = parse("!{{any}}");
		private static final SyntacticType test_678_sub = parse("{!{any}}");
		@Test public void test_678() { testValid(test_678_sup,test_678_sub); }

		private static final SyntacticType test_679_sup = parse("!{{any}}");
		private static final SyntacticType test_679_sub = parse("{!{int}}");
		@Test public void test_679() { testInvalid(test_679_sup,test_679_sub); }

		private static final SyntacticType test_680_sup = parse("!{{any}}");
		private static final SyntacticType test_680_sub = parse("{!!any}");
		@Test public void test_680() { testInvalid(test_680_sup,test_680_sub); }

		private static final SyntacticType test_681_sup = parse("!{{any}}");
		private static final SyntacticType test_681_sub = parse("{!!int}");
		@Test public void test_681() { testValid(test_681_sup,test_681_sub); }

		private static final SyntacticType test_682_sup = parse("!{{any}}");
		private static final SyntacticType test_682_sub = parse("!{{any}}");
		@Test public void test_682() { testValid(test_682_sup,test_682_sub); }

		private static final SyntacticType test_683_sup = parse("!{{any}}");
		private static final SyntacticType test_683_sub = parse("!{{int}}");
		@Test public void test_683() { testInvalid(test_683_sup,test_683_sub); }

		private static final SyntacticType test_684_sup = parse("!{{any}}");
		private static final SyntacticType test_684_sub = parse("!{!any}");
		@Test public void test_684() { testInvalid(test_684_sup,test_684_sub); }

		private static final SyntacticType test_685_sup = parse("!{{any}}");
		private static final SyntacticType test_685_sub = parse("!{!int}");
		@Test public void test_685() { testValid(test_685_sup,test_685_sub); }

		private static final SyntacticType test_686_sup = parse("!{{any}}");
		private static final SyntacticType test_686_sub = parse("!!{any}");
		@Test public void test_686() { testInvalid(test_686_sup,test_686_sub); }

		private static final SyntacticType test_687_sup = parse("!{{any}}");
		private static final SyntacticType test_687_sub = parse("!!{int}");
		@Test public void test_687() { testValid(test_687_sup,test_687_sub); }

		private static final SyntacticType test_688_sup = parse("!{{any}}");
		private static final SyntacticType test_688_sub = parse("!!!any");
		@Test public void test_688() { testValid(test_688_sup,test_688_sub); }

		private static final SyntacticType test_689_sup = parse("!{{any}}");
		private static final SyntacticType test_689_sub = parse("!!!int");
		@Test public void test_689() { testInvalid(test_689_sup,test_689_sub); }

		private static final SyntacticType test_690_sup = parse("!{{int}}");
		private static final SyntacticType test_690_sub = parse("any");
		@Test public void test_690() { testInvalid(test_690_sup,test_690_sub); }

		private static final SyntacticType test_691_sup = parse("!{{int}}");
		private static final SyntacticType test_691_sub = parse("int");
		@Test public void test_691() { testValid(test_691_sup,test_691_sub); }

		private static final SyntacticType test_692_sup = parse("!{{int}}");
		private static final SyntacticType test_692_sub = parse("{any}");
		@Test public void test_692() { testInvalid(test_692_sup,test_692_sub); }

		private static final SyntacticType test_693_sup = parse("!{{int}}");
		private static final SyntacticType test_693_sub = parse("{int}");
		@Test public void test_693() { testValid(test_693_sup,test_693_sub); }

		private static final SyntacticType test_694_sup = parse("!{{int}}");
		private static final SyntacticType test_694_sub = parse("!any");
		@Test public void test_694() { testValid(test_694_sup,test_694_sub); }

		private static final SyntacticType test_695_sup = parse("!{{int}}");
		private static final SyntacticType test_695_sub = parse("!int");
		@Test public void test_695() { testInvalid(test_695_sup,test_695_sub); }

		private static final SyntacticType test_696_sup = parse("!{{int}}");
		private static final SyntacticType test_696_sub = parse("{{any}}");
		@Test public void test_696() { testInvalid(test_696_sup,test_696_sub); }

		private static final SyntacticType test_697_sup = parse("!{{int}}");
		private static final SyntacticType test_697_sub = parse("{{int}}");
		@Test public void test_697() { testInvalid(test_697_sup,test_697_sub); }

		private static final SyntacticType test_698_sup = parse("!{{int}}");
		private static final SyntacticType test_698_sub = parse("{!any}");
		@Test public void test_698() { testValid(test_698_sup,test_698_sub); }

		private static final SyntacticType test_699_sup = parse("!{{int}}");
		private static final SyntacticType test_699_sub = parse("{!int}");
		@Test public void test_699() { testInvalid(test_699_sup,test_699_sub); }

		private static final SyntacticType test_700_sup = parse("!{{int}}");
		private static final SyntacticType test_700_sub = parse("!{any}");
		@Test public void test_700() { testValid(test_700_sup,test_700_sub); }

		private static final SyntacticType test_701_sup = parse("!{{int}}");
		private static final SyntacticType test_701_sub = parse("!{int}");
		@Test public void test_701() { testInvalid(test_701_sup,test_701_sub); }

		private static final SyntacticType test_702_sup = parse("!{{int}}");
		private static final SyntacticType test_702_sub = parse("!!any");
		@Test public void test_702() { testInvalid(test_702_sup,test_702_sub); }

		private static final SyntacticType test_703_sup = parse("!{{int}}");
		private static final SyntacticType test_703_sub = parse("!!int");
		@Test public void test_703() { testValid(test_703_sup,test_703_sub); }

		private static final SyntacticType test_704_sup = parse("!{{int}}");
		private static final SyntacticType test_704_sub = parse("{{{any}}}");
		@Test public void test_704() { testValid(test_704_sup,test_704_sub); }

		private static final SyntacticType test_705_sup = parse("!{{int}}");
		private static final SyntacticType test_705_sub = parse("{{{int}}}");
		@Test public void test_705() { testValid(test_705_sup,test_705_sub); }

		private static final SyntacticType test_706_sup = parse("!{{int}}");
		private static final SyntacticType test_706_sub = parse("{{!any}}");
		@Test public void test_706() { testValid(test_706_sup,test_706_sub); }

		private static final SyntacticType test_707_sup = parse("!{{int}}");
		private static final SyntacticType test_707_sub = parse("{{!int}}");
		@Test public void test_707() { testValid(test_707_sup,test_707_sub); }

		private static final SyntacticType test_708_sup = parse("!{{int}}");
		private static final SyntacticType test_708_sub = parse("{!{any}}");
		@Test public void test_708() { testValid(test_708_sup,test_708_sub); }

		private static final SyntacticType test_709_sup = parse("!{{int}}");
		private static final SyntacticType test_709_sub = parse("{!{int}}");
		@Test public void test_709() { testValid(test_709_sup,test_709_sub); }

		private static final SyntacticType test_710_sup = parse("!{{int}}");
		private static final SyntacticType test_710_sub = parse("{!!any}");
		@Test public void test_710() { testInvalid(test_710_sup,test_710_sub); }

		private static final SyntacticType test_711_sup = parse("!{{int}}");
		private static final SyntacticType test_711_sub = parse("{!!int}");
		@Test public void test_711() { testValid(test_711_sup,test_711_sub); }

		private static final SyntacticType test_712_sup = parse("!{{int}}");
		private static final SyntacticType test_712_sub = parse("!{{any}}");
		@Test public void test_712() { testValid(test_712_sup,test_712_sub); }

		private static final SyntacticType test_713_sup = parse("!{{int}}");
		private static final SyntacticType test_713_sub = parse("!{{int}}");
		@Test public void test_713() { testValid(test_713_sup,test_713_sub); }

		private static final SyntacticType test_714_sup = parse("!{{int}}");
		private static final SyntacticType test_714_sub = parse("!{!any}");
		@Test public void test_714() { testInvalid(test_714_sup,test_714_sub); }

		private static final SyntacticType test_715_sup = parse("!{{int}}");
		private static final SyntacticType test_715_sub = parse("!{!int}");
		@Test public void test_715() { testValid(test_715_sup,test_715_sub); }

		private static final SyntacticType test_716_sup = parse("!{{int}}");
		private static final SyntacticType test_716_sub = parse("!!{any}");
		@Test public void test_716() { testInvalid(test_716_sup,test_716_sub); }

		private static final SyntacticType test_717_sup = parse("!{{int}}");
		private static final SyntacticType test_717_sub = parse("!!{int}");
		@Test public void test_717() { testValid(test_717_sup,test_717_sub); }

		private static final SyntacticType test_718_sup = parse("!{{int}}");
		private static final SyntacticType test_718_sub = parse("!!!any");
		@Test public void test_718() { testValid(test_718_sup,test_718_sub); }

		private static final SyntacticType test_719_sup = parse("!{{int}}");
		private static final SyntacticType test_719_sub = parse("!!!int");
		@Test public void test_719() { testInvalid(test_719_sup,test_719_sub); }

		private static final SyntacticType test_720_sup = parse("!{!any}");
		private static final SyntacticType test_720_sub = parse("any");
		@Test public void test_720() { testValid(test_720_sup,test_720_sub); }

		private static final SyntacticType test_721_sup = parse("!{!any}");
		private static final SyntacticType test_721_sub = parse("int");
		@Test public void test_721() { testValid(test_721_sup,test_721_sub); }

		private static final SyntacticType test_722_sup = parse("!{!any}");
		private static final SyntacticType test_722_sub = parse("{any}");
		@Test public void test_722() { testValid(test_722_sup,test_722_sub); }

		private static final SyntacticType test_723_sup = parse("!{!any}");
		private static final SyntacticType test_723_sub = parse("{int}");
		@Test public void test_723() { testValid(test_723_sup,test_723_sub); }

		private static final SyntacticType test_724_sup = parse("!{!any}");
		private static final SyntacticType test_724_sub = parse("!any");
		@Test public void test_724() { testValid(test_724_sup,test_724_sub); }

		private static final SyntacticType test_725_sup = parse("!{!any}");
		private static final SyntacticType test_725_sub = parse("!int");
		@Test public void test_725() { testValid(test_725_sup,test_725_sub); }

		private static final SyntacticType test_726_sup = parse("!{!any}");
		private static final SyntacticType test_726_sub = parse("{{any}}");
		@Test public void test_726() { testValid(test_726_sup,test_726_sub); }

		private static final SyntacticType test_727_sup = parse("!{!any}");
		private static final SyntacticType test_727_sub = parse("{{int}}");
		@Test public void test_727() { testValid(test_727_sup,test_727_sub); }

		private static final SyntacticType test_728_sup = parse("!{!any}");
		private static final SyntacticType test_728_sub = parse("{!any}");
		@Test public void test_728() { testValid(test_728_sup,test_728_sub); }

		private static final SyntacticType test_729_sup = parse("!{!any}");
		private static final SyntacticType test_729_sub = parse("{!int}");
		@Test public void test_729() { testValid(test_729_sup,test_729_sub); }

		private static final SyntacticType test_730_sup = parse("!{!any}");
		private static final SyntacticType test_730_sub = parse("!{any}");
		@Test public void test_730() { testValid(test_730_sup,test_730_sub); }

		private static final SyntacticType test_731_sup = parse("!{!any}");
		private static final SyntacticType test_731_sub = parse("!{int}");
		@Test public void test_731() { testValid(test_731_sup,test_731_sub); }

		private static final SyntacticType test_732_sup = parse("!{!any}");
		private static final SyntacticType test_732_sub = parse("!!any");
		@Test public void test_732() { testValid(test_732_sup,test_732_sub); }

		private static final SyntacticType test_733_sup = parse("!{!any}");
		private static final SyntacticType test_733_sub = parse("!!int");
		@Test public void test_733() { testValid(test_733_sup,test_733_sub); }

		private static final SyntacticType test_734_sup = parse("!{!any}");
		private static final SyntacticType test_734_sub = parse("{{{any}}}");
		@Test public void test_734() { testValid(test_734_sup,test_734_sub); }

		private static final SyntacticType test_735_sup = parse("!{!any}");
		private static final SyntacticType test_735_sub = parse("{{{int}}}");
		@Test public void test_735() { testValid(test_735_sup,test_735_sub); }

		private static final SyntacticType test_736_sup = parse("!{!any}");
		private static final SyntacticType test_736_sub = parse("{{!any}}");
		@Test public void test_736() { testValid(test_736_sup,test_736_sub); }

		private static final SyntacticType test_737_sup = parse("!{!any}");
		private static final SyntacticType test_737_sub = parse("{{!int}}");
		@Test public void test_737() { testValid(test_737_sup,test_737_sub); }

		private static final SyntacticType test_738_sup = parse("!{!any}");
		private static final SyntacticType test_738_sub = parse("{!{any}}");
		@Test public void test_738() { testValid(test_738_sup,test_738_sub); }

		private static final SyntacticType test_739_sup = parse("!{!any}");
		private static final SyntacticType test_739_sub = parse("{!{int}}");
		@Test public void test_739() { testValid(test_739_sup,test_739_sub); }

		private static final SyntacticType test_740_sup = parse("!{!any}");
		private static final SyntacticType test_740_sub = parse("{!!any}");
		@Test public void test_740() { testValid(test_740_sup,test_740_sub); }

		private static final SyntacticType test_741_sup = parse("!{!any}");
		private static final SyntacticType test_741_sub = parse("{!!int}");
		@Test public void test_741() { testValid(test_741_sup,test_741_sub); }

		private static final SyntacticType test_742_sup = parse("!{!any}");
		private static final SyntacticType test_742_sub = parse("!{{any}}");
		@Test public void test_742() { testValid(test_742_sup,test_742_sub); }

		private static final SyntacticType test_743_sup = parse("!{!any}");
		private static final SyntacticType test_743_sub = parse("!{{int}}");
		@Test public void test_743() { testValid(test_743_sup,test_743_sub); }

		private static final SyntacticType test_744_sup = parse("!{!any}");
		private static final SyntacticType test_744_sub = parse("!{!any}");
		@Test public void test_744() { testValid(test_744_sup,test_744_sub); }

		private static final SyntacticType test_745_sup = parse("!{!any}");
		private static final SyntacticType test_745_sub = parse("!{!int}");
		@Test public void test_745() { testValid(test_745_sup,test_745_sub); }

		private static final SyntacticType test_746_sup = parse("!{!any}");
		private static final SyntacticType test_746_sub = parse("!!{any}");
		@Test public void test_746() { testValid(test_746_sup,test_746_sub); }

		private static final SyntacticType test_747_sup = parse("!{!any}");
		private static final SyntacticType test_747_sub = parse("!!{int}");
		@Test public void test_747() { testValid(test_747_sup,test_747_sub); }

		private static final SyntacticType test_748_sup = parse("!{!any}");
		private static final SyntacticType test_748_sub = parse("!!!any");
		@Test public void test_748() { testValid(test_748_sup,test_748_sub); }

		private static final SyntacticType test_749_sup = parse("!{!any}");
		private static final SyntacticType test_749_sub = parse("!!!int");
		@Test public void test_749() { testValid(test_749_sup,test_749_sub); }

		private static final SyntacticType test_750_sup = parse("!{!int}");
		private static final SyntacticType test_750_sub = parse("any");
		@Test public void test_750() { testInvalid(test_750_sup,test_750_sub); }

		private static final SyntacticType test_751_sup = parse("!{!int}");
		private static final SyntacticType test_751_sub = parse("int");
		@Test public void test_751() { testValid(test_751_sup,test_751_sub); }

		private static final SyntacticType test_752_sup = parse("!{!int}");
		private static final SyntacticType test_752_sub = parse("{any}");
		@Test public void test_752() { testInvalid(test_752_sup,test_752_sub); }

		private static final SyntacticType test_753_sup = parse("!{!int}");
		private static final SyntacticType test_753_sub = parse("{int}");
		@Test public void test_753() { testValid(test_753_sup,test_753_sub); }

		private static final SyntacticType test_754_sup = parse("!{!int}");
		private static final SyntacticType test_754_sub = parse("!any");
		@Test public void test_754() { testValid(test_754_sup,test_754_sub); }

		private static final SyntacticType test_755_sup = parse("!{!int}");
		private static final SyntacticType test_755_sub = parse("!int");
		@Test public void test_755() { testInvalid(test_755_sup,test_755_sub); }

		private static final SyntacticType test_756_sup = parse("!{!int}");
		private static final SyntacticType test_756_sub = parse("{{any}}");
		@Test public void test_756() { testInvalid(test_756_sup,test_756_sub); }

		private static final SyntacticType test_757_sup = parse("!{!int}");
		private static final SyntacticType test_757_sub = parse("{{int}}");
		@Test public void test_757() { testInvalid(test_757_sup,test_757_sub); }

		private static final SyntacticType test_758_sup = parse("!{!int}");
		private static final SyntacticType test_758_sub = parse("{!any}");
		@Test public void test_758() { testValid(test_758_sup,test_758_sub); }

		private static final SyntacticType test_759_sup = parse("!{!int}");
		private static final SyntacticType test_759_sub = parse("{!int}");
		@Test public void test_759() { testInvalid(test_759_sup,test_759_sub); }

		private static final SyntacticType test_760_sup = parse("!{!int}");
		private static final SyntacticType test_760_sub = parse("!{any}");
		@Test public void test_760() { testValid(test_760_sup,test_760_sub); }

		private static final SyntacticType test_761_sup = parse("!{!int}");
		private static final SyntacticType test_761_sub = parse("!{int}");
		@Test public void test_761() { testInvalid(test_761_sup,test_761_sub); }

		private static final SyntacticType test_762_sup = parse("!{!int}");
		private static final SyntacticType test_762_sub = parse("!!any");
		@Test public void test_762() { testInvalid(test_762_sup,test_762_sub); }

		private static final SyntacticType test_763_sup = parse("!{!int}");
		private static final SyntacticType test_763_sub = parse("!!int");
		@Test public void test_763() { testValid(test_763_sup,test_763_sub); }

		private static final SyntacticType test_764_sup = parse("!{!int}");
		private static final SyntacticType test_764_sub = parse("{{{any}}}");
		@Test public void test_764() { testInvalid(test_764_sup,test_764_sub); }

		private static final SyntacticType test_765_sup = parse("!{!int}");
		private static final SyntacticType test_765_sub = parse("{{{int}}}");
		@Test public void test_765() { testInvalid(test_765_sup,test_765_sub); }

		private static final SyntacticType test_766_sup = parse("!{!int}");
		private static final SyntacticType test_766_sub = parse("{{!any}}");
		@Test public void test_766() { testValid(test_766_sup,test_766_sub); }

		private static final SyntacticType test_767_sup = parse("!{!int}");
		private static final SyntacticType test_767_sub = parse("{{!int}}");
		@Test public void test_767() { testInvalid(test_767_sup,test_767_sub); }

		private static final SyntacticType test_768_sup = parse("!{!int}");
		private static final SyntacticType test_768_sub = parse("{!{any}}");
		@Test public void test_768() { testInvalid(test_768_sup,test_768_sub); }

		private static final SyntacticType test_769_sup = parse("!{!int}");
		private static final SyntacticType test_769_sub = parse("{!{int}}");
		@Test public void test_769() { testInvalid(test_769_sup,test_769_sub); }

		private static final SyntacticType test_770_sup = parse("!{!int}");
		private static final SyntacticType test_770_sub = parse("{!!any}");
		@Test public void test_770() { testInvalid(test_770_sup,test_770_sub); }

		private static final SyntacticType test_771_sup = parse("!{!int}");
		private static final SyntacticType test_771_sub = parse("{!!int}");
		@Test public void test_771() { testValid(test_771_sup,test_771_sub); }

		private static final SyntacticType test_772_sup = parse("!{!int}");
		private static final SyntacticType test_772_sub = parse("!{{any}}");
		@Test public void test_772() { testInvalid(test_772_sup,test_772_sub); }

		private static final SyntacticType test_773_sup = parse("!{!int}");
		private static final SyntacticType test_773_sub = parse("!{{int}}");
		@Test public void test_773() { testInvalid(test_773_sup,test_773_sub); }

		private static final SyntacticType test_774_sup = parse("!{!int}");
		private static final SyntacticType test_774_sub = parse("!{!any}");
		@Test public void test_774() { testInvalid(test_774_sup,test_774_sub); }

		private static final SyntacticType test_775_sup = parse("!{!int}");
		private static final SyntacticType test_775_sub = parse("!{!int}");
		@Test public void test_775() { testValid(test_775_sup,test_775_sub); }

		private static final SyntacticType test_776_sup = parse("!{!int}");
		private static final SyntacticType test_776_sub = parse("!!{any}");
		@Test public void test_776() { testInvalid(test_776_sup,test_776_sub); }

		private static final SyntacticType test_777_sup = parse("!{!int}");
		private static final SyntacticType test_777_sub = parse("!!{int}");
		@Test public void test_777() { testValid(test_777_sup,test_777_sub); }

		private static final SyntacticType test_778_sup = parse("!{!int}");
		private static final SyntacticType test_778_sub = parse("!!!any");
		@Test public void test_778() { testValid(test_778_sup,test_778_sub); }

		private static final SyntacticType test_779_sup = parse("!{!int}");
		private static final SyntacticType test_779_sub = parse("!!!int");
		@Test public void test_779() { testInvalid(test_779_sup,test_779_sub); }

		private static final SyntacticType test_780_sup = parse("!!{any}");
		private static final SyntacticType test_780_sub = parse("any");
		@Test public void test_780() { testInvalid(test_780_sup,test_780_sub); }

		private static final SyntacticType test_781_sup = parse("!!{any}");
		private static final SyntacticType test_781_sub = parse("int");
		@Test public void test_781() { testInvalid(test_781_sup,test_781_sub); }

		private static final SyntacticType test_782_sup = parse("!!{any}");
		private static final SyntacticType test_782_sub = parse("{any}");
		@Test public void test_782() { testValid(test_782_sup,test_782_sub); }

		private static final SyntacticType test_783_sup = parse("!!{any}");
		private static final SyntacticType test_783_sub = parse("{int}");
		@Test public void test_783() { testValid(test_783_sup,test_783_sub); }

		private static final SyntacticType test_784_sup = parse("!!{any}");
		private static final SyntacticType test_784_sub = parse("!any");
		@Test public void test_784() { testValid(test_784_sup,test_784_sub); }

		private static final SyntacticType test_785_sup = parse("!!{any}");
		private static final SyntacticType test_785_sub = parse("!int");
		@Test public void test_785() { testInvalid(test_785_sup,test_785_sub); }

		private static final SyntacticType test_786_sup = parse("!!{any}");
		private static final SyntacticType test_786_sub = parse("{{any}}");
		@Test public void test_786() { testValid(test_786_sup,test_786_sub); }

		private static final SyntacticType test_787_sup = parse("!!{any}");
		private static final SyntacticType test_787_sub = parse("{{int}}");
		@Test public void test_787() { testValid(test_787_sup,test_787_sub); }

		private static final SyntacticType test_788_sup = parse("!!{any}");
		private static final SyntacticType test_788_sub = parse("{!any}");
		@Test public void test_788() { testValid(test_788_sup,test_788_sub); }

		private static final SyntacticType test_789_sup = parse("!!{any}");
		private static final SyntacticType test_789_sub = parse("{!int}");
		@Test public void test_789() { testValid(test_789_sup,test_789_sub); }

		private static final SyntacticType test_790_sup = parse("!!{any}");
		private static final SyntacticType test_790_sub = parse("!{any}");
		@Test public void test_790() { testInvalid(test_790_sup,test_790_sub); }

		private static final SyntacticType test_791_sup = parse("!!{any}");
		private static final SyntacticType test_791_sub = parse("!{int}");
		@Test public void test_791() { testInvalid(test_791_sup,test_791_sub); }

		private static final SyntacticType test_792_sup = parse("!!{any}");
		private static final SyntacticType test_792_sub = parse("!!any");
		@Test public void test_792() { testInvalid(test_792_sup,test_792_sub); }

		private static final SyntacticType test_793_sup = parse("!!{any}");
		private static final SyntacticType test_793_sub = parse("!!int");
		@Test public void test_793() { testInvalid(test_793_sup,test_793_sub); }

		private static final SyntacticType test_794_sup = parse("!!{any}");
		private static final SyntacticType test_794_sub = parse("{{{any}}}");
		@Test public void test_794() { testValid(test_794_sup,test_794_sub); }

		private static final SyntacticType test_795_sup = parse("!!{any}");
		private static final SyntacticType test_795_sub = parse("{{{int}}}");
		@Test public void test_795() { testValid(test_795_sup,test_795_sub); }

		private static final SyntacticType test_796_sup = parse("!!{any}");
		private static final SyntacticType test_796_sub = parse("{{!any}}");
		@Test public void test_796() { testValid(test_796_sup,test_796_sub); }

		private static final SyntacticType test_797_sup = parse("!!{any}");
		private static final SyntacticType test_797_sub = parse("{{!int}}");
		@Test public void test_797() { testValid(test_797_sup,test_797_sub); }

		private static final SyntacticType test_798_sup = parse("!!{any}");
		private static final SyntacticType test_798_sub = parse("{!{any}}");
		@Test public void test_798() { testValid(test_798_sup,test_798_sub); }

		private static final SyntacticType test_799_sup = parse("!!{any}");
		private static final SyntacticType test_799_sub = parse("{!{int}}");
		@Test public void test_799() { testValid(test_799_sup,test_799_sub); }

		private static final SyntacticType test_800_sup = parse("!!{any}");
		private static final SyntacticType test_800_sub = parse("{!!any}");
		@Test public void test_800() { testValid(test_800_sup,test_800_sub); }

		private static final SyntacticType test_801_sup = parse("!!{any}");
		private static final SyntacticType test_801_sub = parse("{!!int}");
		@Test public void test_801() { testValid(test_801_sup,test_801_sub); }

		private static final SyntacticType test_802_sup = parse("!!{any}");
		private static final SyntacticType test_802_sub = parse("!{{any}}");
		@Test public void test_802() { testInvalid(test_802_sup,test_802_sub); }

		private static final SyntacticType test_803_sup = parse("!!{any}");
		private static final SyntacticType test_803_sub = parse("!{{int}}");
		@Test public void test_803() { testInvalid(test_803_sup,test_803_sub); }

		private static final SyntacticType test_804_sup = parse("!!{any}");
		private static final SyntacticType test_804_sub = parse("!{!any}");
		@Test public void test_804() { testInvalid(test_804_sup,test_804_sub); }

		private static final SyntacticType test_805_sup = parse("!!{any}");
		private static final SyntacticType test_805_sub = parse("!{!int}");
		@Test public void test_805() { testInvalid(test_805_sup,test_805_sub); }

		private static final SyntacticType test_806_sup = parse("!!{any}");
		private static final SyntacticType test_806_sub = parse("!!{any}");
		@Test public void test_806() { testValid(test_806_sup,test_806_sub); }

		private static final SyntacticType test_807_sup = parse("!!{any}");
		private static final SyntacticType test_807_sub = parse("!!{int}");
		@Test public void test_807() { testValid(test_807_sup,test_807_sub); }

		private static final SyntacticType test_808_sup = parse("!!{any}");
		private static final SyntacticType test_808_sub = parse("!!!any");
		@Test public void test_808() { testValid(test_808_sup,test_808_sub); }

		private static final SyntacticType test_809_sup = parse("!!{any}");
		private static final SyntacticType test_809_sub = parse("!!!int");
		@Test public void test_809() { testInvalid(test_809_sup,test_809_sub); }

		private static final SyntacticType test_810_sup = parse("!!{int}");
		private static final SyntacticType test_810_sub = parse("any");
		@Test public void test_810() { testInvalid(test_810_sup,test_810_sub); }

		private static final SyntacticType test_811_sup = parse("!!{int}");
		private static final SyntacticType test_811_sub = parse("int");
		@Test public void test_811() { testInvalid(test_811_sup,test_811_sub); }

		private static final SyntacticType test_812_sup = parse("!!{int}");
		private static final SyntacticType test_812_sub = parse("{any}");
		@Test public void test_812() { testInvalid(test_812_sup,test_812_sub); }

		private static final SyntacticType test_813_sup = parse("!!{int}");
		private static final SyntacticType test_813_sub = parse("{int}");
		@Test public void test_813() { testValid(test_813_sup,test_813_sub); }

		private static final SyntacticType test_814_sup = parse("!!{int}");
		private static final SyntacticType test_814_sub = parse("!any");
		@Test public void test_814() { testValid(test_814_sup,test_814_sub); }

		private static final SyntacticType test_815_sup = parse("!!{int}");
		private static final SyntacticType test_815_sub = parse("!int");
		@Test public void test_815() { testInvalid(test_815_sup,test_815_sub); }

		private static final SyntacticType test_816_sup = parse("!!{int}");
		private static final SyntacticType test_816_sub = parse("{{any}}");
		@Test public void test_816() { testInvalid(test_816_sup,test_816_sub); }

		private static final SyntacticType test_817_sup = parse("!!{int}");
		private static final SyntacticType test_817_sub = parse("{{int}}");
		@Test public void test_817() { testInvalid(test_817_sup,test_817_sub); }

		private static final SyntacticType test_818_sup = parse("!!{int}");
		private static final SyntacticType test_818_sub = parse("{!any}");
		@Test public void test_818() { testValid(test_818_sup,test_818_sub); }

		private static final SyntacticType test_819_sup = parse("!!{int}");
		private static final SyntacticType test_819_sub = parse("{!int}");
		@Test public void test_819() { testInvalid(test_819_sup,test_819_sub); }

		private static final SyntacticType test_820_sup = parse("!!{int}");
		private static final SyntacticType test_820_sub = parse("!{any}");
		@Test public void test_820() { testInvalid(test_820_sup,test_820_sub); }

		private static final SyntacticType test_821_sup = parse("!!{int}");
		private static final SyntacticType test_821_sub = parse("!{int}");
		@Test public void test_821() { testInvalid(test_821_sup,test_821_sub); }

		private static final SyntacticType test_822_sup = parse("!!{int}");
		private static final SyntacticType test_822_sub = parse("!!any");
		@Test public void test_822() { testInvalid(test_822_sup,test_822_sub); }

		private static final SyntacticType test_823_sup = parse("!!{int}");
		private static final SyntacticType test_823_sub = parse("!!int");
		@Test public void test_823() { testInvalid(test_823_sup,test_823_sub); }

		private static final SyntacticType test_824_sup = parse("!!{int}");
		private static final SyntacticType test_824_sub = parse("{{{any}}}");
		@Test public void test_824() { testInvalid(test_824_sup,test_824_sub); }

		private static final SyntacticType test_825_sup = parse("!!{int}");
		private static final SyntacticType test_825_sub = parse("{{{int}}}");
		@Test public void test_825() { testInvalid(test_825_sup,test_825_sub); }

		private static final SyntacticType test_826_sup = parse("!!{int}");
		private static final SyntacticType test_826_sub = parse("{{!any}}");
		@Test public void test_826() { testValid(test_826_sup,test_826_sub); }

		private static final SyntacticType test_827_sup = parse("!!{int}");
		private static final SyntacticType test_827_sub = parse("{{!int}}");
		@Test public void test_827() { testInvalid(test_827_sup,test_827_sub); }

		private static final SyntacticType test_828_sup = parse("!!{int}");
		private static final SyntacticType test_828_sub = parse("{!{any}}");
		@Test public void test_828() { testInvalid(test_828_sup,test_828_sub); }

		private static final SyntacticType test_829_sup = parse("!!{int}");
		private static final SyntacticType test_829_sub = parse("{!{int}}");
		@Test public void test_829() { testInvalid(test_829_sup,test_829_sub); }

		private static final SyntacticType test_830_sup = parse("!!{int}");
		private static final SyntacticType test_830_sub = parse("{!!any}");
		@Test public void test_830() { testInvalid(test_830_sup,test_830_sub); }

		private static final SyntacticType test_831_sup = parse("!!{int}");
		private static final SyntacticType test_831_sub = parse("{!!int}");
		@Test public void test_831() { testValid(test_831_sup,test_831_sub); }

		private static final SyntacticType test_832_sup = parse("!!{int}");
		private static final SyntacticType test_832_sub = parse("!{{any}}");
		@Test public void test_832() { testInvalid(test_832_sup,test_832_sub); }

		private static final SyntacticType test_833_sup = parse("!!{int}");
		private static final SyntacticType test_833_sub = parse("!{{int}}");
		@Test public void test_833() { testInvalid(test_833_sup,test_833_sub); }

		private static final SyntacticType test_834_sup = parse("!!{int}");
		private static final SyntacticType test_834_sub = parse("!{!any}");
		@Test public void test_834() { testInvalid(test_834_sup,test_834_sub); }

		private static final SyntacticType test_835_sup = parse("!!{int}");
		private static final SyntacticType test_835_sub = parse("!{!int}");
		@Test public void test_835() { testInvalid(test_835_sup,test_835_sub); }

		private static final SyntacticType test_836_sup = parse("!!{int}");
		private static final SyntacticType test_836_sub = parse("!!{any}");
		@Test public void test_836() { testInvalid(test_836_sup,test_836_sub); }

		private static final SyntacticType test_837_sup = parse("!!{int}");
		private static final SyntacticType test_837_sub = parse("!!{int}");
		@Test public void test_837() { testValid(test_837_sup,test_837_sub); }

		private static final SyntacticType test_838_sup = parse("!!{int}");
		private static final SyntacticType test_838_sub = parse("!!!any");
		@Test public void test_838() { testValid(test_838_sup,test_838_sub); }

		private static final SyntacticType test_839_sup = parse("!!{int}");
		private static final SyntacticType test_839_sub = parse("!!!int");
		@Test public void test_839() { testInvalid(test_839_sup,test_839_sub); }

		private static final SyntacticType test_840_sup = parse("!!!any");
		private static final SyntacticType test_840_sub = parse("any");
		@Test public void test_840() { testInvalid(test_840_sup,test_840_sub); }

		private static final SyntacticType test_841_sup = parse("!!!any");
		private static final SyntacticType test_841_sub = parse("int");
		@Test public void test_841() { testInvalid(test_841_sup,test_841_sub); }

		private static final SyntacticType test_842_sup = parse("!!!any");
		private static final SyntacticType test_842_sub = parse("{any}");
		@Test public void test_842() { testInvalid(test_842_sup,test_842_sub); }

		private static final SyntacticType test_843_sup = parse("!!!any");
		private static final SyntacticType test_843_sub = parse("{int}");
		@Test public void test_843() { testInvalid(test_843_sup,test_843_sub); }

		private static final SyntacticType test_844_sup = parse("!!!any");
		private static final SyntacticType test_844_sub = parse("!any");
		@Test public void test_844() { testValid(test_844_sup,test_844_sub); }

		private static final SyntacticType test_845_sup = parse("!!!any");
		private static final SyntacticType test_845_sub = parse("!int");
		@Test public void test_845() { testInvalid(test_845_sup,test_845_sub); }

		private static final SyntacticType test_846_sup = parse("!!!any");
		private static final SyntacticType test_846_sub = parse("{{any}}");
		@Test public void test_846() { testInvalid(test_846_sup,test_846_sub); }

		private static final SyntacticType test_847_sup = parse("!!!any");
		private static final SyntacticType test_847_sub = parse("{{int}}");
		@Test public void test_847() { testInvalid(test_847_sup,test_847_sub); }

		private static final SyntacticType test_848_sup = parse("!!!any");
		private static final SyntacticType test_848_sub = parse("{!any}");
		@Test public void test_848() { testValid(test_848_sup,test_848_sub); }

		private static final SyntacticType test_849_sup = parse("!!!any");
		private static final SyntacticType test_849_sub = parse("{!int}");
		@Test public void test_849() { testInvalid(test_849_sup,test_849_sub); }

		private static final SyntacticType test_850_sup = parse("!!!any");
		private static final SyntacticType test_850_sub = parse("!{any}");
		@Test public void test_850() { testInvalid(test_850_sup,test_850_sub); }

		private static final SyntacticType test_851_sup = parse("!!!any");
		private static final SyntacticType test_851_sub = parse("!{int}");
		@Test public void test_851() { testInvalid(test_851_sup,test_851_sub); }

		private static final SyntacticType test_852_sup = parse("!!!any");
		private static final SyntacticType test_852_sub = parse("!!any");
		@Test public void test_852() { testInvalid(test_852_sup,test_852_sub); }

		private static final SyntacticType test_853_sup = parse("!!!any");
		private static final SyntacticType test_853_sub = parse("!!int");
		@Test public void test_853() { testInvalid(test_853_sup,test_853_sub); }

		private static final SyntacticType test_854_sup = parse("!!!any");
		private static final SyntacticType test_854_sub = parse("{{{any}}}");
		@Test public void test_854() { testInvalid(test_854_sup,test_854_sub); }

		private static final SyntacticType test_855_sup = parse("!!!any");
		private static final SyntacticType test_855_sub = parse("{{{int}}}");
		@Test public void test_855() { testInvalid(test_855_sup,test_855_sub); }

		private static final SyntacticType test_856_sup = parse("!!!any");
		private static final SyntacticType test_856_sub = parse("{{!any}}");
		@Test public void test_856() { testValid(test_856_sup,test_856_sub); }

		private static final SyntacticType test_857_sup = parse("!!!any");
		private static final SyntacticType test_857_sub = parse("{{!int}}");
		@Test public void test_857() { testInvalid(test_857_sup,test_857_sub); }

		private static final SyntacticType test_858_sup = parse("!!!any");
		private static final SyntacticType test_858_sub = parse("{!{any}}");
		@Test public void test_858() { testInvalid(test_858_sup,test_858_sub); }

		private static final SyntacticType test_859_sup = parse("!!!any");
		private static final SyntacticType test_859_sub = parse("{!{int}}");
		@Test public void test_859() { testInvalid(test_859_sup,test_859_sub); }

		private static final SyntacticType test_860_sup = parse("!!!any");
		private static final SyntacticType test_860_sub = parse("{!!any}");
		@Test public void test_860() { testInvalid(test_860_sup,test_860_sub); }

		private static final SyntacticType test_861_sup = parse("!!!any");
		private static final SyntacticType test_861_sub = parse("{!!int}");
		@Test public void test_861() { testInvalid(test_861_sup,test_861_sub); }

		private static final SyntacticType test_862_sup = parse("!!!any");
		private static final SyntacticType test_862_sub = parse("!{{any}}");
		@Test public void test_862() { testInvalid(test_862_sup,test_862_sub); }

		private static final SyntacticType test_863_sup = parse("!!!any");
		private static final SyntacticType test_863_sub = parse("!{{int}}");
		@Test public void test_863() { testInvalid(test_863_sup,test_863_sub); }

		private static final SyntacticType test_864_sup = parse("!!!any");
		private static final SyntacticType test_864_sub = parse("!{!any}");
		@Test public void test_864() { testInvalid(test_864_sup,test_864_sub); }

		private static final SyntacticType test_865_sup = parse("!!!any");
		private static final SyntacticType test_865_sub = parse("!{!int}");
		@Test public void test_865() { testInvalid(test_865_sup,test_865_sub); }

		private static final SyntacticType test_866_sup = parse("!!!any");
		private static final SyntacticType test_866_sub = parse("!!{any}");
		@Test public void test_866() { testInvalid(test_866_sup,test_866_sub); }

		private static final SyntacticType test_867_sup = parse("!!!any");
		private static final SyntacticType test_867_sub = parse("!!{int}");
		@Test public void test_867() { testInvalid(test_867_sup,test_867_sub); }

		private static final SyntacticType test_868_sup = parse("!!!any");
		private static final SyntacticType test_868_sub = parse("!!!any");
		@Test public void test_868() { testValid(test_868_sup,test_868_sub); }

		private static final SyntacticType test_869_sup = parse("!!!any");
		private static final SyntacticType test_869_sub = parse("!!!int");
		@Test public void test_869() { testInvalid(test_869_sup,test_869_sub); }

		private static final SyntacticType test_870_sup = parse("!!!int");
		private static final SyntacticType test_870_sub = parse("any");
		@Test public void test_870() { testInvalid(test_870_sup,test_870_sub); }

		private static final SyntacticType test_871_sup = parse("!!!int");
		private static final SyntacticType test_871_sub = parse("int");
		@Test public void test_871() { testInvalid(test_871_sup,test_871_sub); }

		private static final SyntacticType test_872_sup = parse("!!!int");
		private static final SyntacticType test_872_sub = parse("{any}");
		@Test public void test_872() { testValid(test_872_sup,test_872_sub); }

		private static final SyntacticType test_873_sup = parse("!!!int");
		private static final SyntacticType test_873_sub = parse("{int}");
		@Test public void test_873() { testValid(test_873_sup,test_873_sub); }

		private static final SyntacticType test_874_sup = parse("!!!int");
		private static final SyntacticType test_874_sub = parse("!any");
		@Test public void test_874() { testValid(test_874_sup,test_874_sub); }

		private static final SyntacticType test_875_sup = parse("!!!int");
		private static final SyntacticType test_875_sub = parse("!int");
		@Test public void test_875() { testValid(test_875_sup,test_875_sub); }

		private static final SyntacticType test_876_sup = parse("!!!int");
		private static final SyntacticType test_876_sub = parse("{{any}}");
		@Test public void test_876() { testValid(test_876_sup,test_876_sub); }

		private static final SyntacticType test_877_sup = parse("!!!int");
		private static final SyntacticType test_877_sub = parse("{{int}}");
		@Test public void test_877() { testValid(test_877_sup,test_877_sub); }

		private static final SyntacticType test_878_sup = parse("!!!int");
		private static final SyntacticType test_878_sub = parse("{!any}");
		@Test public void test_878() { testValid(test_878_sup,test_878_sub); }

		private static final SyntacticType test_879_sup = parse("!!!int");
		private static final SyntacticType test_879_sub = parse("{!int}");
		@Test public void test_879() { testValid(test_879_sup,test_879_sub); }

		private static final SyntacticType test_880_sup = parse("!!!int");
		private static final SyntacticType test_880_sub = parse("!{any}");
		@Test public void test_880() { testInvalid(test_880_sup,test_880_sub); }

		private static final SyntacticType test_881_sup = parse("!!!int");
		private static final SyntacticType test_881_sub = parse("!{int}");
		@Test public void test_881() { testInvalid(test_881_sup,test_881_sub); }

		private static final SyntacticType test_882_sup = parse("!!!int");
		private static final SyntacticType test_882_sub = parse("!!any");
		@Test public void test_882() { testInvalid(test_882_sup,test_882_sub); }

		private static final SyntacticType test_883_sup = parse("!!!int");
		private static final SyntacticType test_883_sub = parse("!!int");
		@Test public void test_883() { testInvalid(test_883_sup,test_883_sub); }

		private static final SyntacticType test_884_sup = parse("!!!int");
		private static final SyntacticType test_884_sub = parse("{{{any}}}");
		@Test public void test_884() { testValid(test_884_sup,test_884_sub); }

		private static final SyntacticType test_885_sup = parse("!!!int");
		private static final SyntacticType test_885_sub = parse("{{{int}}}");
		@Test public void test_885() { testValid(test_885_sup,test_885_sub); }

		private static final SyntacticType test_886_sup = parse("!!!int");
		private static final SyntacticType test_886_sub = parse("{{!any}}");
		@Test public void test_886() { testValid(test_886_sup,test_886_sub); }

		private static final SyntacticType test_887_sup = parse("!!!int");
		private static final SyntacticType test_887_sub = parse("{{!int}}");
		@Test public void test_887() { testValid(test_887_sup,test_887_sub); }

		private static final SyntacticType test_888_sup = parse("!!!int");
		private static final SyntacticType test_888_sub = parse("{!{any}}");
		@Test public void test_888() { testValid(test_888_sup,test_888_sub); }

		private static final SyntacticType test_889_sup = parse("!!!int");
		private static final SyntacticType test_889_sub = parse("{!{int}}");
		@Test public void test_889() { testValid(test_889_sup,test_889_sub); }

		private static final SyntacticType test_890_sup = parse("!!!int");
		private static final SyntacticType test_890_sub = parse("{!!any}");
		@Test public void test_890() { testValid(test_890_sup,test_890_sub); }

		private static final SyntacticType test_891_sup = parse("!!!int");
		private static final SyntacticType test_891_sub = parse("{!!int}");
		@Test public void test_891() { testValid(test_891_sup,test_891_sub); }

		private static final SyntacticType test_892_sup = parse("!!!int");
		private static final SyntacticType test_892_sub = parse("!{{any}}");
		@Test public void test_892() { testInvalid(test_892_sup,test_892_sub); }

		private static final SyntacticType test_893_sup = parse("!!!int");
		private static final SyntacticType test_893_sub = parse("!{{int}}");
		@Test public void test_893() { testInvalid(test_893_sup,test_893_sub); }

		private static final SyntacticType test_894_sup = parse("!!!int");
		private static final SyntacticType test_894_sub = parse("!{!any}");
		@Test public void test_894() { testInvalid(test_894_sup,test_894_sub); }

		private static final SyntacticType test_895_sup = parse("!!!int");
		private static final SyntacticType test_895_sub = parse("!{!int}");
		@Test public void test_895() { testInvalid(test_895_sup,test_895_sub); }

		private static final SyntacticType test_896_sup = parse("!!!int");
		private static final SyntacticType test_896_sub = parse("!!{any}");
		@Test public void test_896() { testValid(test_896_sup,test_896_sub); }

		private static final SyntacticType test_897_sup = parse("!!!int");
		private static final SyntacticType test_897_sub = parse("!!{int}");
		@Test public void test_897() { testValid(test_897_sup,test_897_sub); }

		private static final SyntacticType test_898_sup = parse("!!!int");
		private static final SyntacticType test_898_sub = parse("!!!any");
		@Test public void test_898() { testValid(test_898_sup,test_898_sub); }

		private static final SyntacticType test_899_sup = parse("!!!int");
		private static final SyntacticType test_899_sub = parse("!!!int");
